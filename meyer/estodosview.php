...
$estodos_view = NULL; // Initialize page object first

class cestodos_view extends cestodos {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["codigo"] <> "") {
				...
				$sReturnUrl = "estodoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "estodoslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "estodoslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_estodos\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_estodos',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.festodosview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($estodos_view)) $estodos_view = new cestodos_view();

// Page init
$estodos_view->Page_Init();

// Page main
$estodos_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$estodos_view->Page_Render();
?>
...
// Page object
var estodos_view = new ew_Page("estodos_view");
estodos_view.PageID = "view"; // Page ID
var EW_PAGE_ID = estodos_view.PageID; // For backward compatibility

// Form object
var festodosview = new ew_Form("festodosview");

// Form_CustomValidate event
festodosview.Form_CustomValidate = 
...
festodosview.ValidateRequired = true;
<?php } else { ?>
festodosview.ValidateRequired = false; 
<?php } ?>
...
<?php $estodos_view->ExportOptions->Render("body") ?>
<?php if (!$estodos_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($estodos_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $estodos_view->ShowPageHeader(); ?>
<?php
$estodos_view->ShowMessage();
?>
<form name="festodosview" id="festodosview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="estodos">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_estodosview" class="table table-bordered table-striped">
<?php if ($estodos->codigo->Visible) { // codigo ?>
	<tr id="r_codigo">
		<td><span id="elh_estodos_codigo"><?php echo $estodos->codigo->FldCaption() ?></span></td>
...
<?php echo $estodos->codigo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $estodos->estdo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $estodos->activo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

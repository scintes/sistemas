...
<?php if ($usuario->codigo->Visible) { // codigo ?>
		<td><span id="elh_usuario_codigo" class="usuario_codigo"><?php echo $usuario->codigo->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $usuario_delete->RowCnt ?>_usuario_codigo" class="control-group usuario_codigo">

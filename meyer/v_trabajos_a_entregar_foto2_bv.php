...
$v_trabajos_a_entregar_foto2_blobview = NULL; // Initialize page object first

class cv_trabajos_a_entregar_foto2_blobview extends cv_trabajos_a_entregar {
	...
	// Page object name
	var $PageObjName = 'v_trabajos_a_entregar_foto2_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('v_trabajos_a_entregar', 'x_foto2');

		// Show thumbnail
		$bShowThumbnail = (@$_GET["showthumbnail"] == "1");
		if (@$_GET["thumbnailwidth"] == "" && @$_GET["thumbnailheight"] == "") {
			$iThumbnailWidth = 10; // Set default width
			$iThumbnailHeight = 10; // Set default height
		} else {
...
// Create page object
if (!isset($v_trabajos_a_entregar_foto2_blobview)) $v_trabajos_a_entregar_foto2_blobview = new cv_trabajos_a_entregar_foto2_blobview();

// Page init
$v_trabajos_a_entregar_foto2_blobview->Page_Init();

// Page main
$v_trabajos_a_entregar_foto2_blobview->Page_Main();
?>
<?php
$v_trabajos_a_entregar_foto2_blobview->Page_Terminate();
?>

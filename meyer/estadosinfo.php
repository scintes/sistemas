...
//
// Table class for estados
//
class cestados extends cTable {
	var $codigo;
	var $estado;
	var $activo;
	...
	function __construct() {
		...
		// codigo
		$this->codigo = new cField('estados', 'estados', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 3, -1, FALSE, '`codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->codigo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codigo'] = &$this->codigo;

		// estado
		$this->estado = new cField('estados', 'estados', 'x_estado', 'estado', '`estado`', '`estado`', 200, -1, FALSE, '`estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['estado'] = &$this->estado;

		// activo
		$this->activo = new cField('estados', 'estados', 'x_activo', 'activo', '`activo`', '`activo`', 200, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("estadosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("estadosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "estadosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("estadosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("estadosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("estadosdelete.php", $this->UrlParm());
	}

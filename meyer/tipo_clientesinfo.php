...
//
// Table class for tipo_clientes
//
class ctipo_clientes extends cTable {
	var $codigo;
	var $tipo_cliente;
	var $activo;
	...
	function __construct() {
		...
		$this->TableVar = 'tipo_clientes';
		$this->TableName = 'tipo_clientes';
		...
		// codigo
		$this->codigo = new cField('tipo_clientes', 'tipo_clientes', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 3, -1, FALSE, '`codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->codigo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codigo'] = &$this->codigo;

		// tipo_cliente
		$this->tipo_cliente = new cField('tipo_clientes', 'tipo_clientes', 'x_tipo_cliente', 'tipo_cliente', '`tipo_cliente`', '`tipo_cliente`', 200, -1, FALSE, '`tipo_cliente`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['tipo_cliente'] = &$this->tipo_cliente;

		// activo
		$this->activo = new cField('tipo_clientes', 'tipo_clientes', 'x_activo', 'activo', '`activo`', '`activo`', 200, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("tipo_clientesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("tipo_clientesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "tipo_clientesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tipo_clientesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tipo_clientesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tipo_clientesdelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->tipo_cliente->Exportable) $Doc->ExportCaption($this->tipo_cliente);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->tipo_cliente->Exportable) $Doc->ExportField($this->tipo_cliente);

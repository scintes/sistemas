...
<?php if ($usuario->contrasenia->Visible) { // contrasenia ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->contrasenia) ?>',1);"><div id="elh_usuario_contrasenia" class="usuario_contrasenia">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuario->contrasenia->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuario->contrasenia->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuario->contrasenia->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
...
<?php if ($usuario->codigo->Visible) { // codigo ?>
	<?php if ($usuario->SortUrl($usuario->codigo) == "") { ?>
		<td><div id="elh_usuario_codigo" class="usuario_codigo"><div class="ewTableHeaderCaption"><?php echo $usuario->codigo->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->codigo) ?>',1);"><div id="elh_usuario_codigo" class="usuario_codigo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuario->codigo->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuario->codigo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuario->codigo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php

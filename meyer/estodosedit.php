...
$estodos_edit = NULL; // Initialize page object first

class cestodos_edit extends cestodos {
	...
	function Page_Main() {
		...
		if ($this->codigo->CurrentValue == "")
			$this->Page_Terminate("estodoslist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->estdo->SetDbValueDef($rsnew, $this->estdo->CurrentValue, NULL, $this->estdo->ReadOnly);
...
// Create page object
if (!isset($estodos_edit)) $estodos_edit = new cestodos_edit();

// Page init
$estodos_edit->Page_Init();

// Page main
$estodos_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$estodos_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var estodos_edit = new ew_Page("estodos_edit");
estodos_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = estodos_edit.PageID; // For backward compatibility

// Form object
var festodosedit = new ew_Form("festodosedit");

// Validate form
festodosedit.Validate = function() {
...
festodosedit.Form_CustomValidate = 
...
festodosedit.ValidateRequired = true;
<?php } else { ?>
festodosedit.ValidateRequired = false; 
<?php } ?>
...
<?php $estodos_edit->ShowPageHeader(); ?>
<?php
$estodos_edit->ShowMessage();
?>
<form name="festodosedit" id="festodosedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="estodos">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_estodosedit" class="table table-bordered table-striped">
...
<?php echo $estodos->codigo->EditValue ?></span>
</span>
<input type="hidden" data-field="x_codigo" name="x_codigo" id="x_codigo" value="<?php echo ew_HtmlEncode($estodos->codigo->CurrentValue) ?>">

...
$Report1_foto2_blobview = NULL; // Initialize page object first

class cReport1_foto2_blobview extends ctrabajos {
	...
	// Page object name
	var $PageObjName = 'Report1_foto2_blobview';
...
// Create page object
if (!isset($Report1_foto2_blobview)) $Report1_foto2_blobview = new cReport1_foto2_blobview();

// Page init
$Report1_foto2_blobview->Page_Init();

// Page main
$Report1_foto2_blobview->Page_Main();
?>
<?php
$Report1_foto2_blobview->Page_Terminate();
?>

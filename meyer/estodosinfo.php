...
//
// Table class for estodos
//
class cestodos extends cTable {
	var $codigo;
	var $estdo;
	var $activo;
	...
	function __construct() {
		...
		$this->TableVar = 'estodos';
		$this->TableName = 'estodos';
		...
		// codigo
		$this->codigo = new cField('estodos', 'estodos', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 3, -1, FALSE, '`codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->codigo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codigo'] = &$this->codigo;

		// estdo
		$this->estdo = new cField('estodos', 'estodos', 'x_estdo', 'estdo', '`estdo`', '`estdo`', 200, -1, FALSE, '`estdo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['estdo'] = &$this->estdo;

		// activo
		$this->activo = new cField('estodos', 'estodos', 'x_activo', 'activo', '`activo`', '`activo`', 200, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("estodosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("estodosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "estodosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("estodosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("estodosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("estodosdelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->estdo->Exportable) $Doc->ExportCaption($this->estdo);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->estdo->Exportable) $Doc->ExportField($this->estdo);

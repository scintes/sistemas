...
define("EW_PROJECT_ID", "{83DA4882-2FB3-4AE9-BADA-241C2F6A6920}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'HFlPJhbIu2OGuKaI', TRUE); // Random key for encryption

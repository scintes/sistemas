...
if ($provincias_deleteTotalRecs <= 0) { // No record found, exit
	...
	$provincias_delete->Page_Terminate("provinciaslist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
<?php if ($provincias->codigo->Visible) { // codigo ?>
		<th><span id="elh_provincias_codigo" class="provincias_codigo"><?php echo $provincias->codigo->FldCaption() ?></span></th>
<?php } ?>
...
<span id="el<?php echo $provincias_delete->RowCnt ?>_provincias_codigo" class="provincias_codigo">

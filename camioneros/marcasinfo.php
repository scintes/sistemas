...
class cmarcas extends cTable {
	...
	function __construct() {
		...
		// codigo
		$this->codigo = new cField('marcas', 'marcas', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 3, -1, FALSE, '`codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->codigo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codigo'] = &$this->codigo;

		// marca
		$this->marca = new cField('marcas', 'marcas', 'x_marca', 'marca', '`marca`', '`marca`', 200, -1, FALSE, '`marca`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['marca'] = &$this->marca;

		// modelo
		$this->modelo = new cField('marcas', 'marcas', 'x_modelo', 'modelo', '`modelo`', '`modelo`', 200, -1, FALSE, '`modelo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "marcasadd.php?" . $this->UrlParm($parm);
		else

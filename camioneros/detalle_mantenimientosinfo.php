...
$detalle_mantenimientos = NULL;

//
// Table class for detalle_mantenimientos
//
class cdetalle_mantenimientos extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'detalle_mantenimientos';
		$this->TableName = 'detalle_mantenimientos';
		...
		$this->id_hoja_mantenimiento = new cField('detalle_mantenimientos', 'detalle_mantenimientos', 'x_id_hoja_mantenimiento', 'id_hoja_mantenimiento', '`id_hoja_mantenimiento`', '`id_hoja_mantenimiento`', 3, -1, FALSE, '`id_hoja_mantenimiento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// descripcion
		$this->descripcion = new cField('detalle_mantenimientos', 'detalle_mantenimientos', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 200, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['descripcion'] = &$this->descripcion;

		// fecha
		$this->fecha = new cField('detalle_mantenimientos', 'detalle_mantenimientos', 'x_fecha', 'fecha', '`fecha`', 'DATE_FORMAT(`fecha`, \'%d/%m/%Y\')', 133, 7, FALSE, '`fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fecha->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['fecha'] = &$this->fecha;

		// hora_trabajo
		$this->hora_trabajo = new cField('detalle_mantenimientos', 'detalle_mantenimientos', 'x_hora_trabajo', 'hora_trabajo', '`hora_trabajo`', '`hora_trabajo`', 3, -1, FALSE, '`hora_trabajo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->hora_trabajo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['hora_trabajo'] = &$this->hora_trabajo;

		// id_tipo_mantenimiento
		$this->id_tipo_mantenimiento = new cField('detalle_mantenimientos', 'detalle_mantenimientos', 'x_id_tipo_mantenimiento', 'id_tipo_mantenimiento', '`id_tipo_mantenimiento`', '`id_tipo_mantenimiento`', 3, -1, FALSE, '`id_tipo_mantenimiento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`detalle_mantenimientos`";
	}
	...
	// Update Table
	var $UpdateTable = "`detalle_mantenimientos`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "detalle_mantenimientoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("detalle_mantenimientosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("detalle_mantenimientosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "detalle_mantenimientosadd.php?" . $this->UrlParm($parm);
		else
			return "detalle_mantenimientosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("detalle_mantenimientosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("detalle_mantenimientosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("detalle_mantenimientosdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		// hora_trabajo
		$this->hora_trabajo->EditAttrs["class"] = "form-control";
		$this->hora_trabajo->EditCustomAttributes = "";
		$this->hora_trabajo->EditValue = ew_HtmlEncode($this->hora_trabajo->CurrentValue);
		$this->hora_trabajo->PlaceHolder = ew_RemoveHtml($this->hora_trabajo->FldCaption());

		// id_tipo_mantenimiento
		$this->id_tipo_mantenimiento->EditAttrs["class"] = "form-control";
		$this->id_tipo_mantenimiento->EditCustomAttributes = "";
		$this->id_tipo_mantenimiento->EditValue = ew_HtmlEncode($this->id_tipo_mantenimiento->CurrentValue);
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->hora_trabajo->Exportable) $Doc->ExportCaption($this->hora_trabajo);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->hora_trabajo->Exportable) $Doc->ExportField($this->hora_trabajo);

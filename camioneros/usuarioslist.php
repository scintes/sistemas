...
<?php if ($usuarios->codigo->Visible) { // codigo ?>
	<?php if ($usuarios->SortUrl($usuarios->codigo) == "") { ?>
		<th data-name="codigo"><div id="elh_usuarios_codigo" class="usuarios_codigo"><div class="ewTableHeaderCaption"><?php echo $usuarios->codigo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="codigo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->codigo) ?>',1);"><div id="elh_usuarios_codigo" class="usuarios_codigo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->codigo->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->codigo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->codigo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		

...
$choferes_view = NULL; // Initialize page object first

class cchoferes_view extends cchoferes {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "chofereslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "chofereslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($choferes_view)) $choferes_view = new cchoferes_view();

// Page init
$choferes_view->Page_Init();

// Page main
$choferes_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$choferes_view->Page_Render();
?>
...
// Page object
var choferes_view = new ew_Page("choferes_view");
choferes_view.PageID = "view"; // Page ID
var EW_PAGE_ID = choferes_view.PageID; // For backward compatibility

// Form object
var fchoferesview = new ew_Form("fchoferesview");

// Form_CustomValidate event
fchoferesview.Form_CustomValidate = 
...
fchoferesview.ValidateRequired = true;
<?php } else { ?>
fchoferesview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $choferes_view->ExportOptions->Render("body") ?>
<?php
	foreach ($choferes_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($choferes->Export == "") { ?>
...
<?php } ?>
<?php $choferes_view->ShowPageHeader(); ?>
<?php
$choferes_view->ShowMessage();
?>
<?php if ($choferes->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($choferes_view->Pager)) $choferes_view->Pager = new cNumericPager($choferes_view->StartRec, $choferes_view->DisplayRecs, $choferes_view->TotalRecs, $choferes_view->RecRange) ?>
<?php if ($choferes_view->Pager->RecordCount > 0) { ?>
<div class="ewPager">
<div class="ewNumericPage"><ul class="pagination">
	<?php if ($choferes_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $choferes_view->PageUrl() ?>start=<?php echo $choferes_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($choferes_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $choferes_view->PageUrl() ?>start=<?php echo $choferes_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($choferes_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $choferes_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($choferes_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $choferes_view->PageUrl() ?>start=<?php echo $choferes_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($choferes_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $choferes_view->PageUrl() ?>start=<?php echo $choferes_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
<?php } ?>
...
<?php } ?>
<form name="fchoferesview" id="fchoferesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($choferes_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $choferes_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="choferes">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($choferes->codigo->Visible) { // codigo ?>
	<tr id="r_codigo">
		<td><span id="elh_choferes_codigo"><?php echo $choferes->codigo->FldCaption() ?></span></td>
		<td<?php echo $choferes->codigo->CellAttributes() ?>>
<span id="el_choferes_codigo">
<span<?php echo $choferes->codigo->ViewAttributes() ?>>
<?php echo $choferes->codigo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($choferes->nombre->Visible) { // nombre ?>
	<tr id="r_nombre">
		<td><span id="elh_choferes_nombre"><?php echo $choferes->nombre->FldCaption() ?></span></td>
		<td<?php echo $choferes->nombre->CellAttributes() ?>>
<span id="el_choferes_nombre">
<span<?php echo $choferes->nombre->ViewAttributes() ?>>
<?php echo $choferes->nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($choferes->direccion->Visible) { // direccion ?>
	<tr id="r_direccion">
		<td><span id="elh_choferes_direccion"><?php echo $choferes->direccion->FldCaption() ?></span></td>
...
<?php echo $choferes->direccion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($choferes->fecha_nacimiento->Visible) { // fecha_nacimiento ?>
	<tr id="r_fecha_nacimiento">
		<td><span id="elh_choferes_fecha_nacimiento"><?php echo $choferes->fecha_nacimiento->FldCaption() ?></span></td>
...
<?php echo $choferes->fecha_nacimiento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($choferes->tel->Visible) { // tel ?>
	<tr id="r_tel">
		<td><span id="elh_choferes_tel"><?php echo $choferes->tel->FldCaption() ?></span></td>
		<td<?php echo $choferes->tel->CellAttributes() ?>>
<span id="el_choferes_tel">
<span<?php echo $choferes->tel->ViewAttributes() ?>>
<?php echo $choferes->tel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($choferes->cel->Visible) { // cel ?>
	<tr id="r_cel">
		<td><span id="elh_choferes_cel"><?php echo $choferes->cel->FldCaption() ?></span></td>
		<td<?php echo $choferes->cel->CellAttributes() ?>>
<span id="el_choferes_cel">
<span<?php echo $choferes->cel->ViewAttributes() ?>>
<?php echo $choferes->cel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($choferes->_email->Visible) { // email ?>
	<tr id="r__email">
		<td><span id="elh_choferes__email"><?php echo $choferes->_email->FldCaption() ?></span></td>
		<td<?php echo $choferes->_email->CellAttributes() ?>>
<span id="el_choferes__email">
<span<?php echo $choferes->_email->ViewAttributes() ?>>
<?php echo $choferes->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($choferes->fecha_inicio->Visible) { // fecha_inicio ?>
	<tr id="r_fecha_inicio">
		<td><span id="elh_choferes_fecha_inicio"><?php echo $choferes->fecha_inicio->FldCaption() ?></span></td>
...
<?php echo $choferes->fecha_inicio->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($choferes->cetegoria->Visible) { // cetegoria ?>
	<tr id="r_cetegoria">
		<td><span id="elh_choferes_cetegoria"><?php echo $choferes->cetegoria->FldCaption() ?></span></td>
...
<?php echo $choferes->cetegoria->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($choferes->datos->Visible) { // datos ?>
	<tr id="r_datos">
		<td><span id="elh_choferes_datos"><?php echo $choferes->datos->FldCaption() ?></span></td>
		<td<?php echo $choferes->datos->CellAttributes() ?>>
<span id="el_choferes_datos">
<span<?php echo $choferes->datos->ViewAttributes() ?>>
<?php echo $choferes->datos->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

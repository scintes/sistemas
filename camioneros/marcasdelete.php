...
<?php if ($marcas->codigo->Visible) { // codigo ?>
		<th><span id="elh_marcas_codigo" class="marcas_codigo"><?php echo $marcas->codigo->FldCaption() ?></span></th>
<?php } ?>
<?php if ($marcas->marca->Visible) { // marca ?>
		<th><span id="elh_marcas_marca" class="marcas_marca"><?php echo $marcas->marca->FldCaption() ?></span></th>
<?php } ?>
<?php if ($marcas->modelo->Visible) { // modelo ?>
		<th><span id="elh_marcas_modelo" class="marcas_modelo"><?php echo $marcas->modelo->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $marcas_delete->RowCnt ?>_marcas_codigo" class="marcas_codigo">
...
<span id="el<?php echo $marcas_delete->RowCnt ?>_marcas_marca" class="marcas_marca">
...
<span id="el<?php echo $marcas_delete->RowCnt ?>_marcas_modelo" class="marcas_modelo">

...
$RootMenu->AddMenuItem(15, "mci_ABM_de_Datos_Base", $Language->MenuPhrase("15", "MenuText"), "", -1, "", TRUE, FALSE, TRUE);
...
$RootMenu->AddMenuItem(76, "mi_usuarios", $Language->MenuPhrase("76", "MenuText"), "usuarioslist.php", 84, "", IsLoggedIn(), FALSE);

...
$v_hoja_manteniminto = NULL;

//
// Table class for v_hoja_manteniminto
//
class cv_hoja_manteniminto extends cTable {
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v_hoja_manteniminto`";
	}
	...
	// Update Table
	var $UpdateTable = "`v_hoja_manteniminto`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "v_hoja_mantenimintolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("v_hoja_mantenimintoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("v_hoja_mantenimintoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "v_hoja_mantenimintoadd.php?" . $this->UrlParm($parm);
		else
			return "v_hoja_mantenimintoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("v_hoja_mantenimintoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("v_hoja_mantenimintoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_hoja_mantenimintodelete.php", $this->UrlParm());
	}

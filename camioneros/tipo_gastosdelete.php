...
$tipo_gastos_delete = NULL; // Initialize page object first

class ctipo_gastos_delete extends ctipo_gastos {
	...
	// Page object name
	var $PageObjName = 'tipo_gastos_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("tipo_gastoslist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in tipo_gastos class, tipo_gastosinfo.php
...
// Create page object
if (!isset($tipo_gastos_delete)) $tipo_gastos_delete = new ctipo_gastos_delete();

// Page init
$tipo_gastos_delete->Page_Init();

// Page main
$tipo_gastos_delete->Page_Main();
...
// Page object
var tipo_gastos_delete = new ew_Page("tipo_gastos_delete");
tipo_gastos_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = tipo_gastos_delete.PageID; // For backward compatibility

// Form object
var ftipo_gastosdelete = new ew_Form("ftipo_gastosdelete");

// Form_CustomValidate event
ftipo_gastosdelete.Form_CustomValidate = 
...
ftipo_gastosdelete.ValidateRequired = true;
<?php } else { ?>
ftipo_gastosdelete.ValidateRequired = false; 
<?php } ?>
...
if ($tipo_gastos_delete->Recordset = $tipo_gastos_delete->LoadRecordset())
	$tipo_gastos_deleteTotalRecs = $tipo_gastos_delete->Recordset->RecordCount(); // Get record count
if ($tipo_gastos_deleteTotalRecs <= 0) { // No record found, exit
	if ($tipo_gastos_delete->Recordset)
		$tipo_gastos_delete->Recordset->Close();
	$tipo_gastos_delete->Page_Terminate("tipo_gastoslist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
?>
<form name="ftipo_gastosdelete" id="ftipo_gastosdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tipo_gastos_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tipo_gastos_delete->Token ?>">
<?php } ?>
...
<?php if ($tipo_gastos->codigo->Visible) { // codigo ?>
		<th><span id="elh_tipo_gastos_codigo" class="tipo_gastos_codigo"><?php echo $tipo_gastos->codigo->FldCaption() ?></span></th>
<?php } ?>
<?php if ($tipo_gastos->tipo_gasto->Visible) { // tipo_gasto ?>
		<th><span id="elh_tipo_gastos_tipo_gasto" class="tipo_gastos_tipo_gasto"><?php echo $tipo_gastos->tipo_gasto->FldCaption() ?></span></th>
<?php } ?>
<?php if ($tipo_gastos->clase->Visible) { // clase ?>
		<th><span id="elh_tipo_gastos_clase" class="tipo_gastos_clase"><?php echo $tipo_gastos->clase->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$tipo_gastos_delete->RecCnt = 0;
$i = 0;
while (!$tipo_gastos_delete->Recordset->EOF) {
	$tipo_gastos_delete->RecCnt++;
	$tipo_gastos_delete->RowCnt++;

	// Set row properties
	$tipo_gastos->ResetAttrs();
	$tipo_gastos->RowType = EW_ROWTYPE_VIEW; // View
...
<span id="el<?php echo $tipo_gastos_delete->RowCnt ?>_tipo_gastos_codigo" class="tipo_gastos_codigo">
...
<span id="el<?php echo $tipo_gastos_delete->RowCnt ?>_tipo_gastos_tipo_gasto" class="tipo_gastos_tipo_gasto">
...
<span id="el<?php echo $tipo_gastos_delete->RowCnt ?>_tipo_gastos_clase" class="tipo_gastos_clase">
...
<?php
$tipo_gastos_delete->Page_Terminate();
?>

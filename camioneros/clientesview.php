...
fclientesview.Lists["x_id_localidad"] = {"LinkField":"x_codigo","Ajax":true,"AutoFill":false,"DisplayFields":["x_localidad","x_cp","x_provincia",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if (!isset($clientes_view->Pager)) $clientes_view->Pager = new cNumericPager($clientes_view->StartRec, $clientes_view->DisplayRecs, $clientes_view->TotalRecs, $clientes_view->RecRange) ?>
<?php if ($clientes_view->Pager->RecordCount > 0) { ?>
<div class="ewPager">
<div class="ewNumericPage"><ul class="pagination">
	<?php if ($clientes_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $clientes_view->PageUrl() ?>start=<?php echo $clientes_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($clientes_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $clientes_view->PageUrl() ?>start=<?php echo $clientes_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($clientes_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $clientes_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($clientes_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $clientes_view->PageUrl() ?>start=<?php echo $clientes_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($clientes_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $clientes_view->PageUrl() ?>start=<?php echo $clientes_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
<?php } ?>
...
<?php if ($clientes->codigo->Visible) { // codigo ?>
	<tr id="r_codigo">
		<td><span id="elh_clientes_codigo"><?php echo $clientes->codigo->FldCaption() ?></span></td>
		<td<?php echo $clientes->codigo->CellAttributes() ?>>
<span id="el_clientes_codigo">
<span<?php echo $clientes->codigo->ViewAttributes() ?>>
<?php echo $clientes->codigo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($clientes->cuit_cuil->Visible) { // cuit_cuil ?>
	<tr id="r_cuit_cuil">
		<td><span id="elh_clientes_cuit_cuil"><?php echo $clientes->cuit_cuil->FldCaption() ?></span></td>
...
<?php echo $clientes->cuit_cuil->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($clientes->razon_social->Visible) { // razon_social ?>
	<tr id="r_razon_social">
		<td><span id="elh_clientes_razon_social"><?php echo $clientes->razon_social->FldCaption() ?></span></td>
...
<?php echo $clientes->razon_social->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($clientes->responsable->Visible) { // responsable ?>
	<tr id="r_responsable">
		<td><span id="elh_clientes_responsable"><?php echo $clientes->responsable->FldCaption() ?></span></td>
...
<?php echo $clientes->responsable->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($clientes->tel->Visible) { // tel ?>
	<tr id="r_tel">
		<td><span id="elh_clientes_tel"><?php echo $clientes->tel->FldCaption() ?></span></td>
		<td<?php echo $clientes->tel->CellAttributes() ?>>
<span id="el_clientes_tel">
<span<?php echo $clientes->tel->ViewAttributes() ?>>
<?php echo $clientes->tel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($clientes->cel->Visible) { // cel ?>
	<tr id="r_cel">
		<td><span id="elh_clientes_cel"><?php echo $clientes->cel->FldCaption() ?></span></td>
		<td<?php echo $clientes->cel->CellAttributes() ?>>
<span id="el_clientes_cel">
<span<?php echo $clientes->cel->ViewAttributes() ?>>
<?php echo $clientes->cel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($clientes->_email->Visible) { // email ?>
	<tr id="r__email">
		<td><span id="elh_clientes__email"><?php echo $clientes->_email->FldCaption() ?></span></td>
		<td<?php echo $clientes->_email->CellAttributes() ?>>
<span id="el_clientes__email">
<span<?php echo $clientes->_email->ViewAttributes() ?>>
<?php echo $clientes->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($clientes->direccion->Visible) { // direccion ?>
	<tr id="r_direccion">
		<td><span id="elh_clientes_direccion"><?php echo $clientes->direccion->FldCaption() ?></span></td>
...
<?php echo $clientes->direccion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($clientes->id_localidad->Visible) { // id_localidad ?>
	<tr id="r_id_localidad">
		<td><span id="elh_clientes_id_localidad"><?php echo $clientes->id_localidad->FldCaption() ?></span></td>
...
<?php echo $clientes->id_localidad->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "vehiculosview.php")
...
// Page object
var vehiculos_add = new ew_Page("vehiculos_add");
vehiculos_add.PageID = "add"; // Page ID
var EW_PAGE_ID = vehiculos_add.PageID; // For backward compatibility

// Form object
var fvehiculosadd = new ew_Form("fvehiculosadd");
...
fvehiculosadd.ValidateRequired = true;
<?php } else { ?>
fvehiculosadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvehiculosadd.Lists["x_id_chofer"] = {"LinkField":"x_codigo","Ajax":true,"AutoFill":false,"DisplayFields":["x_codigo","x_nombre","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fvehiculosadd.Lists["x_id_guarda"] = {"LinkField":"x_codigo","Ajax":true,"AutoFill":false,"DisplayFields":["x_codigo","x_nombre","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fvehiculosadd.Lists["x_id_marca"] = {"LinkField":"x_codigo","Ajax":true,"AutoFill":false,"DisplayFields":["x_marca","x_modelo","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="fvehiculosadd" id="fvehiculosadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">

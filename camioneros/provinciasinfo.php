...
class cprovincias extends cTable {
	...
	function __construct() {
		...
		// codigo
		$this->codigo = new cField('provincias', 'provincias', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 3, -1, FALSE, '`codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("provinciasview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("provinciasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "provinciasadd.php?" . $this->UrlParm($parm);
		else
			return "provinciasadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("provinciasedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("provinciasadd.php", $this->UrlParm($parm));
	}

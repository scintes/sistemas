...
$v_localidad_provincia = NULL;

//
// Table class for v_localidad_provincia
//
class cv_localidad_provincia extends cTable {
	var $localidad;
	var $cp;
	var $provincia;
	var $codigo;
	...
	function __construct() {
		...
		$this->TableVar = 'v_localidad_provincia';
		$this->TableName = 'v_localidad_provincia';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// localidad
		$this->localidad = new cField('v_localidad_provincia', 'v_localidad_provincia', 'x_localidad', 'localidad', '`localidad`', '`localidad`', 200, -1, FALSE, '`localidad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['localidad'] = &$this->localidad;

		// cp
		$this->cp = new cField('v_localidad_provincia', 'v_localidad_provincia', 'x_cp', 'cp', '`cp`', '`cp`', 3, -1, FALSE, '`cp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->cp->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cp'] = &$this->cp;

		// provincia
		$this->provincia = new cField('v_localidad_provincia', 'v_localidad_provincia', 'x_provincia', 'provincia', '`provincia`', '`provincia`', 200, -1, FALSE, '`provincia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['provincia'] = &$this->provincia;

		// codigo
		$this->codigo = new cField('v_localidad_provincia', 'v_localidad_provincia', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 3, -1, FALSE, '`codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v_localidad_provincia`";
	}
	...
	// Update Table
	var $UpdateTable = "`v_localidad_provincia`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "v_localidad_provincialist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("v_localidad_provinciaview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("v_localidad_provinciaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "v_localidad_provinciaadd.php?" . $this->UrlParm($parm);
		else
			return "v_localidad_provinciaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("v_localidad_provinciaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("v_localidad_provinciaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_localidad_provinciadelete.php", $this->UrlParm());
	}

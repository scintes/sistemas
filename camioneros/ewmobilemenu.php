...
$RootMenu->AddMenuItem(155, "mmi_backup_v1_php", $Language->MenuPhrase("155", "MenuText"), "inicio/backup_v1.php", 153, "", IsLoggedIn(), FALSE);
...
$RootMenu->AddMenuItem(119, "mmi_nivel_permisos_usuario", $Language->MenuPhrase("119", "MenuText"), "nivel_permisos_usuariolist.php", 154, "", IsLoggedIn(), FALSE);
$RootMenu->AddMenuItem(120, "mmi_nivel_usuario", $Language->MenuPhrase("120", "MenuText"), "nivel_usuariolist.php", 154, "", IsLoggedIn(), FALSE);
$RootMenu->AddMenuItem(76, "mmi_usuarios", $Language->MenuPhrase("76", "MenuText"), "usuarioslist.php", 154, "", IsLoggedIn(), FALSE);

...
class cmarcas_addopt extends cmarcas {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					...
					$row["x_marca"] = $this->marca->DbValue;
	...
	function RestoreFormValues() {
		global $objForm;
		$this->marca->CurrentValue = ew_ConvertToUtf8($this->marca->FormValue);
...
// Page object
var marcas_addopt = new ew_Page("marcas_addopt");
marcas_addopt.PageID = "addopt"; // Page ID
var EW_PAGE_ID = marcas_addopt.PageID; // For backward compatibility

// Form object
var fmarcasaddopt = new ew_Form("fmarcasaddopt");
...
fmarcasaddopt.ValidateRequired = true;
<?php } else { ?>
fmarcasaddopt.ValidateRequired = false; 
<?php } ?>
...
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_marca"><?php echo $marcas->marca->FldCaption() ?></label>
		<div class="col-sm-9">
<input type="text" data-field="x_marca" name="x_marca" id="x_marca" size="30" maxlength="15" placeholder="<?php echo ew_HtmlEncode($marcas->marca->PlaceHolder) ?>" value="<?php echo $marcas->marca->EditValue ?>"<?php echo $marcas->marca->EditAttributes() ?>>
	...
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_modelo"><?php echo $marcas->modelo->FldCaption() ?></label>
		<div class="col-sm-9">

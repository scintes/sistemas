...
//
// Table class for talleres
//
class ctalleres extends cTable {
	var $codigo;
	var $taller;
	var $direccion;
	var $tel;
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`talleres`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("talleresview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("talleresview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "talleresadd.php?" . $this->UrlParm($parm);
		else
			return "talleresadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("talleresedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("talleresadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("talleresdelete.php", $this->UrlParm());
	}

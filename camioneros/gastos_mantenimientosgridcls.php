...
$gastos_mantenimientos_grid = NULL; // Initialize page object first

class cgastos_mantenimientos_grid extends cgastos_mantenimientos {
	...
	// Page object name
	var $PageObjName = 'gastos_mantenimientos_grid';

	// Grid form hidden field names
	var $FormName = 'fgastos_mantenimientosgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["gastos_mantenimientos"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_id_tipo_gasto") && $objForm->HasValue("o_id_tipo_gasto") && $this->id_tipo_gasto->CurrentValue <> $this->id_tipo_gasto->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_id_hoja_mantenimeinto") && $objForm->HasValue("o_id_hoja_mantenimeinto") && $this->id_hoja_mantenimeinto->CurrentValue <> $this->id_hoja_mantenimeinto->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->id_hoja_mantenimeinto->setOldValue($objForm->GetValue("o_id_hoja_mantenimeinto"));
	}
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "hoja_mantenimientos") {
			$this->id_hoja_mantenimeinto->Visible = FALSE;

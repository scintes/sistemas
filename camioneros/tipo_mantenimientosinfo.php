...
$tipo_mantenimientos = NULL;

//
// Table class for tipo_mantenimientos
//
class ctipo_mantenimientos extends cTable {
	var $codigo;
	...
	function __construct() {
		...
		$this->TableVar = 'tipo_mantenimientos';
		$this->TableName = 'tipo_mantenimientos';
		...
		// codigo
		$this->codigo = new cField('tipo_mantenimientos', 'tipo_mantenimientos', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 3, -1, FALSE, '`codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->codigo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codigo'] = &$this->codigo;

		// tipo_mantenimiento
		$this->tipo_mantenimiento = new cField('tipo_mantenimientos', 'tipo_mantenimientos', 'x_tipo_mantenimiento', 'tipo_mantenimiento', '`tipo_mantenimiento`', '`tipo_mantenimiento`', 200, -1, FALSE, '`tipo_mantenimiento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tipo_mantenimientos`";
	}
	...
	// Update Table
	var $UpdateTable = "`tipo_mantenimientos`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tipo_mantenimientoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("tipo_mantenimientosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("tipo_mantenimientosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "tipo_mantenimientosadd.php?" . $this->UrlParm($parm);
		else
			return "tipo_mantenimientosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tipo_mantenimientosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tipo_mantenimientosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tipo_mantenimientosdelete.php", $this->UrlParm());
	}

...
$v_gastos_m_grid = NULL; // Initialize page object first

class cv_gastos_m_grid extends cv_gastos_m {
	...
	// Page object name
	var $PageObjName = 'v_gastos_m_grid';

	// Grid form hidden field names
	var $FormName = 'fv_gastos_mgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["v_gastos_m"];

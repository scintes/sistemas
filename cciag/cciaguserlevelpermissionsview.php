...
class cuserlevelpermissions_view extends cuserlevelpermissions {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["userlevelid"] <> "") {
				...
				$sReturnUrl = "cciaguserlevelpermissionslist.php"; // Return to list
			}
			if (@$_GET["_tablename"] <> "") {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cciaguserlevelpermissionslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cciaguserlevelpermissionslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", "<span id=\"ewPageCaption\">" . $PageCaption . "</span>", "cciaguserlevelpermissionslist.php", $this->TableVar);
...
fuserlevelpermissionsview.Lists["x_userlevelid"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};

...
class cuserlevels_view extends cuserlevels {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["userlevelid"] <> "") {
				...
				$sReturnUrl = "cciaguserlevelslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cciaguserlevelslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cciaguserlevelslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", "<span id=\"ewPageCaption\">" . $PageCaption . "</span>", "cciaguserlevelslist.php", $this->TableVar);

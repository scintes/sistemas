...
if (!isset($Language)) {
	include_once "cciagewcfg10.php";
	include_once "cciagewshared10.php";
...
// Ajax settings
var EW_LOOKUP_FILE_NAME = "cciagewlookup10.php"; // Lookup file name
...
<script type="text/javascript" src="phpjs/cciagewp10.js"></script>
<?php } ?>
<?php if (@$gsExport == "") { ?>
<script type="text/javascript" src="phpjs/cciaguserfn10.js"></script>
<script type="text/javascript">
<?php echo $Language->ToJSON() ?>
</script>
<script type="text/javascript" src="phpjs/swfobject.js"></script>
<script type="text/javascript" src="phpjs/cciagewflashfiles.js"></script>
<script type="text/javascript">
...
<div data-role="page">
	<div data-role="header">
		<a href="cciagmobilemenu.php"><?php echo $Language->Phrase("MobileMenu") ?></a>
		<h1 id="ewPageTitle"></h1>
	<?php if (IsLoggedIn()) { ?>
		<a href="cciaglogout.php"><?php echo $Language->Phrase("Logout") ?></a>
	<?php } elseif (substr(ew_ScriptName(), 0 - strlen("cciaglogin.php")) <> "cciaglogin.php") { ?>
		<a href="cciaglogin.php"><?php echo $Language->Phrase("Login") ?></a>
	<?php } ?>
	</div>
<?php } ?>
<?php } ?>
...
<?php if (!ew_IsMobile()) { ?>
  ...
  <div id="ewHeaderRow" class="ewHeaderRow"><img src="phpimages/berries.jpg" alt="" style="border: 0;">	</div>
	<!-- header (end) -->
<?php } ?>
<?php if (ew_IsMobile()) { ?>
...
<?php } else { ?>
	...
	<table id="ewContentTable" cellspacing="0" class="ewContentTable">
		<tr><td id="ewMenuColumn" class="ewMenuColumn">
			<!-- left column (begin) -->
<?php include_once "cciagewmenu.php" ?>
			<!-- left column (end) -->
		</td>
<?php } ?>

...
class cusuario_list extends cusuario {
	...
	function __construct() {
		...
		$this->AddUrl = "cciag_usuarioadd.php";
		$this->InlineAddUrl = $this->PageUrl() . "a=add";
		$this->GridAddUrl = $this->PageUrl() . "a=gridadd";
		$this->GridEditUrl = $this->PageUrl() . "a=gridedit";
		$this->MultiDeleteUrl = "cciag_usuariodelete.php";
		$this->MultiUpdateUrl = "cciag_usuarioupdate.php";
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->contrasenia, $Default, FALSE); // contrasenia
		...
		if (!$Default && $this->Command == "search") {
			...
			$this->contrasenia->AdvancedSearch->Save(); // contrasenia
	...
	function CheckSearchParms() {
		...
		if ($this->usuario->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->contrasenia->AdvancedSearch->IssetSession())
			return TRUE;
	...
	function ResetAdvancedSearchParms() {
		...
		$this->contrasenia->AdvancedSearch->UnsetSession();
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<a class=\"btn btn-default ewAdvancedSearch\" title=\"" . $Language->Phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->Phrase("AdvancedSearch") . "\" href=\"cciag_usuariosrch.php\">" . $Language->Phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->Add("searchhighlight");
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewHighlight active\" title=\"" . $Language->Phrase("Highlight") . "\" data-caption=\"" . $Language->Phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"fusuariolistsrch\" data-name=\"" . $this->HighlightName() . "\">" . $Language->Phrase("HighlightBtn") . "</button>";
	...
	function LoadSearchValues() {
		...
		// contrasenia
		$this->contrasenia->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_contrasenia"]);
		if ($this->contrasenia->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->contrasenia->AdvancedSearch->SearchOperator = @$_GET["z_contrasenia"];
	...
	function ExportQueryString() {
		...
		$this->AddSearchQueryString($sQry, $this->usuario); // usuario
		$this->AddSearchQueryString($sQry, $this->contrasenia); // contrasenia
		$this->AddSearchQueryString($sQry, $this->nombre); // nombre
...
<?php if ($usuario->contrasenia->Visible) { // contrasenia ?>
	<?php if ($usuario->SortUrl($usuario->contrasenia) == "") { ?>
		<th data-name="contrasenia"><div id="elh_usuario_contrasenia" class="usuario_contrasenia"><div class="ewTableHeaderCaption"><?php echo $usuario->contrasenia->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="contrasenia"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->contrasenia) ?>',1);"><div id="elh_usuario_contrasenia" class="usuario_contrasenia">
...
<?php if ($usuario->nombre->Visible) { // nombre ?>
	<?php if ($usuario->SortUrl($usuario->nombre) == "") { ?>
		<th data-name="nombre"><div id="elh_usuario_nombre" class="usuario_nombre"><div class="ewTableHeaderCaption"><?php echo $usuario->nombre->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nombre"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->nombre) ?>',1);"><div id="elh_usuario_nombre" class="usuario_nombre">
...
<?php if ($usuario->_email->Visible) { // email ?>
	<?php if ($usuario->SortUrl($usuario->_email) == "") { ?>
		<th data-name="_email"><div id="elh_usuario__email" class="usuario__email"><div class="ewTableHeaderCaption"><?php echo $usuario->_email->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_email"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->_email) ?>',1);"><div id="elh_usuario__email" class="usuario__email">
...
<?php if ($usuario->cel->Visible) { // cel ?>
	<?php if ($usuario->SortUrl($usuario->cel) == "") { ?>
		<th data-name="cel"><div id="elh_usuario_cel" class="usuario_cel"><div class="ewTableHeaderCaption"><?php echo $usuario->cel->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="cel"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->cel) ?>',1);"><div id="elh_usuario_cel" class="usuario_cel">
...
<?php if ($usuario->activo->Visible) { // activo ?>
	<?php if ($usuario->SortUrl($usuario->activo) == "") { ?>
		<th data-name="activo"><div id="elh_usuario_activo" class="usuario_activo"><div class="ewTableHeaderCaption"><?php echo $usuario->activo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="activo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->activo) ?>',1);"><div id="elh_usuario_activo" class="usuario_activo">
...
<?php echo $usuario->usuario->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($usuario->contrasenia->Visible) { // contrasenia ?>
		<td data-name="contrasenia"<?php echo $usuario->contrasenia->CellAttributes() ?>>
...
<?php echo $usuario->_email->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($usuario->cel->Visible) { // cel ?>
		<td data-name="cel"<?php echo $usuario->cel->CellAttributes() ?>>
<span<?php echo $usuario->cel->ViewAttributes() ?>>
<?php echo $usuario->cel->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($usuario->activo->Visible) { // activo ?>
		<td data-name="activo"<?php echo $usuario->activo->CellAttributes() ?>>

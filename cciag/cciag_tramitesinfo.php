...
//
// Table class for tramites
//
class ctramites extends cTable {
	var $codigo;
	var $Titulo;
	var $Descripcion;
	var $fecha;
	...
	function __construct() {
		...
		// codigo
		$this->codigo = new cField('tramites', 'tramites', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 3, -1, FALSE, '`codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->codigo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codigo'] = &$this->codigo;

		// Titulo
		$this->Titulo = new cField('tramites', 'tramites', 'x_Titulo', 'Titulo', '`Titulo`', '`Titulo`', 200, -1, FALSE, '`Titulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Titulo'] = &$this->Titulo;

		// Descripcion
		$this->Descripcion = new cField('tramites', 'tramites', 'x_Descripcion', 'Descripcion', '`Descripcion`', '`Descripcion`', 201, -1, FALSE, '`Descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Descripcion'] = &$this->Descripcion;

		// fecha
		$this->fecha = new cField('tramites', 'tramites', 'x_fecha', 'fecha', '`fecha`', 'DATE_FORMAT(`fecha`, \'%d/%m/%Y\')', 133, 7, FALSE, '`fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fecha->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['fecha'] = &$this->fecha;

		// id_usuario
		$this->id_usuario = new cField('tramites', 'tramites', 'x_id_usuario', 'id_usuario', '`id_usuario`', '`id_usuario`', 200, -1, FALSE, '`id_usuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['id_usuario'] = &$this->id_usuario;

		// archivo
		$this->archivo = new cField('tramites', 'tramites', 'x_archivo', 'archivo', '`archivo`', '`archivo`', 200, -1, TRUE, '`archivo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->archivo->UploadMultiple = TRUE;
		$this->fields['archivo'] = &$this->archivo;

		// estado
		$this->estado = new cField('tramites', 'tramites', 'x_estado', 'estado', '`estado`', '`estado`', 200, -1, FALSE, '`estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "seguimiento_tramites") {
			$sDetailUrl = $GLOBALS["seguimiento_tramites"]->GetListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&fk_codigo=" . urlencode($this->codigo->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "cciag_tramiteslist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tramites`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_tramitesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_tramitesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "cciag_tramitesadd.php?" . $this->UrlParm($parm);
		else
			return "cciag_tramitesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_tramitesedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_tramitesedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_tramitesadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_tramitesadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cciag_tramitesdelete.php", $this->UrlParm());
	}

...
$detalles_view = NULL; // Initialize page object first

class cdetalles_view extends cdetalles {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cciag_detalleslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cciag_detalleslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($detalles_view)) $detalles_view = new cdetalles_view();

// Page init
$detalles_view->Page_Init();

// Page main
$detalles_view->Page_Main();
...
// Page object
var detalles_view = new ew_Page("detalles_view");
detalles_view.PageID = "view"; // Page ID
var EW_PAGE_ID = detalles_view.PageID; // For backward compatibility

// Form object
var fdetallesview = new ew_Form("fdetallesview");

// Form_CustomValidate event
fdetallesview.Form_CustomValidate = 
...
fdetallesview.ValidateRequired = true;
<?php } else { ?>
fdetallesview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $detalles_view->ExportOptions->Render("body") ?>
<?php
	foreach ($detalles_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($detalles->Export == "") { ?>
...
<?php } ?>
<?php $detalles_view->ShowPageHeader(); ?>
<?php
$detalles_view->ShowMessage();
?>
<form name="fdetallesview" id="fdetallesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($detalles_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $detalles_view->Token ?>">
<?php } ?>
...
<?php
	if (in_array("socios_detalles", explode(",", $detalles->getCurrentDetailTable())) && $socios_detalles->DetailView) {
?>

...
class csocios_list extends csocios {
	...
	function __construct() {
		...
		$this->AddUrl = "cciagsociosadd.php";
		$this->InlineAddUrl = $this->PageUrl() . "a=add";
		$this->GridAddUrl = $this->PageUrl() . "a=gridadd";
		$this->GridEditUrl = $this->PageUrl() . "a=gridedit";
		$this->MultiDeleteUrl = "cciagsociosdelete.php";
		$this->MultiUpdateUrl = "cciagsociosupdate.php";
	...
	function BasicSearchSQL($Keyword) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->cuit_cuil, $Keyword);
		return $sWhere;
	}
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_socios\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_socios',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fsocioslist,sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
<?php } ?>
<?php if ($socios_list->ExportOptions->Visible()) { ?>
<div class="ewListExportOptions"><?php $socios_list->ExportOptions->Render("body") ?></div>
<?php } ?>
<?php
	$bSelectLimit = EW_SELECT_LIMIT;
	if ($bSelectLimit) {
...
<form name="fsocioslistsrch" id="fsocioslistsrch" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>">
<table class="ewSearchTable"><tr><td>
<div class="accordion" id="fsocioslistsrch_SearchGroup">
	<div class="accordion-group">
		<div class="accordion-heading">
<a class="accordion-toggle" data-toggle="collapse" data-parent="#fsocioslistsrch_SearchGroup" href="#fsocioslistsrch_SearchBody"><?php echo $Language->Phrase("Search") ?></a>
		</div>
		<div id="fsocioslistsrch_SearchBody" class="accordion-body collapse in">
			<div class="accordion-inner">
<div id="fsocioslistsrch_SearchPanel">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="input-large" value="<?php echo ew_HtmlEncode($socios_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo $Language->Phrase("Search") ?>">
	<button class="btn btn-primary ewButton" name="btnsubmit" id="btnsubmit" type="submit"><?php echo $Language->Phrase("QuickSearchBtn") ?></button>
	</div>
	</div>
	<div class="btn-group ewButtonGroup">
	<a class="btn ewShowAll" href="<?php echo $socios_list->PageUrl() ?>cmd=reset"><?php echo $Language->Phrase("ShowAll") ?></a>
</div>
<div id="xsr_2" class="ewRow">
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="="<?php if ($socios_list->BasicSearch->getType() == "=") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="AND"<?php if ($socios_list->BasicSearch->getType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="OR"<?php if ($socios_list->BasicSearch->getType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?></label>
</div>
</div>
</div>
			</div>
...
<!--first page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $socios_list->PageUrl() ?>start=<?php echo $socios_list->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
...
<!--previous page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $socios_list->PageUrl() ?>start=<?php echo $socios_list->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" type="button" disabled="disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $socios_list->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($socios_list->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" type="button" href="<?php echo $socios_list->PageUrl() ?>start=<?php echo $socios_list->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" type="button" disabled="disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($socios_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" type="button" href="<?php echo $socios_list->PageUrl() ?>start=<?php echo $socios_list->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" type="button" disabled="disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $socios_list->Pager->PageCount ?>
</td>
<td>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $socios_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $socios_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $socios_list->Pager->RecordCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
	<?php if ($socios_list->SearchWhere == "0=101") { ?>
...
<?php } ?>
<form name="fsocioslist" id="fsocioslist" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="socios">
<div id="gmp_socios" class="ewGridMiddlePanel">
<?php if ($socios_list->TotalRecs > 0) { ?>
<table id="tbl_socioslist" class="ewTable ewTableSeparate">
...
<?php if ($socios->socio_nro->Visible) { // socio_nro ?>
	<?php if ($socios->SortUrl($socios->socio_nro) == "") { ?>
		<td><div id="elh_socios_socio_nro" class="socios_socio_nro"><div class="ewTableHeaderCaption"><?php echo $socios->socio_nro->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $socios->SortUrl($socios->socio_nro) ?>',1);"><div id="elh_socios_socio_nro" class="socios_socio_nro">
...
<?php if ($socios->id_usuario->Visible) { // id_usuario ?>
	<?php if ($socios->SortUrl($socios->id_usuario) == "") { ?>
		<td><div id="elh_socios_id_usuario" class="socios_id_usuario"><div class="ewTableHeaderCaption"><?php echo $socios->id_usuario->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $socios->SortUrl($socios->id_usuario) ?>',1);"><div id="elh_socios_id_usuario" class="socios_id_usuario">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $socios->id_usuario->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($socios->id_usuario->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($socios->id_usuario->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($socios->propietario->Visible) { // propietario ?>
	<?php if ($socios->SortUrl($socios->propietario) == "") { ?>
		<td><div id="elh_socios_propietario" class="socios_propietario"><div class="ewTableHeaderCaption"><?php echo $socios->propietario->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $socios->SortUrl($socios->propietario) ?>',1);"><div id="elh_socios_propietario" class="socios_propietario">
...
<?php if ($socios->comercio->Visible) { // comercio ?>
	<?php if ($socios->SortUrl($socios->comercio) == "") { ?>
		<td><div id="elh_socios_comercio" class="socios_comercio"><div class="ewTableHeaderCaption"><?php echo $socios->comercio->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $socios->SortUrl($socios->comercio) ?>',1);"><div id="elh_socios_comercio" class="socios_comercio">
...
<?php if ($socios->direccion_comercio->Visible) { // direccion_comercio ?>
	<?php if ($socios->SortUrl($socios->direccion_comercio) == "") { ?>
		<td><div id="elh_socios_direccion_comercio" class="socios_direccion_comercio"><div class="ewTableHeaderCaption"><?php echo $socios->direccion_comercio->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $socios->SortUrl($socios->direccion_comercio) ?>',1);"><div id="elh_socios_direccion_comercio" class="socios_direccion_comercio">
...
<?php if ($socios->activo->Visible) { // activo ?>
	<?php if ($socios->SortUrl($socios->activo) == "") { ?>
		<td><div id="elh_socios_activo" class="socios_activo"><div class="ewTableHeaderCaption"><?php echo $socios->activo->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $socios->SortUrl($socios->activo) ?>',1);"><div id="elh_socios_activo" class="socios_activo">
...
<?php if ($socios->mail->Visible) { // mail ?>
	<?php if ($socios->SortUrl($socios->mail) == "") { ?>
		<td><div id="elh_socios_mail" class="socios_mail"><div class="ewTableHeaderCaption"><?php echo $socios->mail->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $socios->SortUrl($socios->mail) ?>',1);"><div id="elh_socios_mail" class="socios_mail">
...
<?php if ($socios->tel->Visible) { // tel ?>
	<?php if ($socios->SortUrl($socios->tel) == "") { ?>
		<td><div id="elh_socios_tel" class="socios_tel"><div class="ewTableHeaderCaption"><?php echo $socios->tel->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $socios->SortUrl($socios->tel) ?>',1);"><div id="elh_socios_tel" class="socios_tel">
...
<?php if ($socios->cel->Visible) { // cel ?>
	<?php if ($socios->SortUrl($socios->cel) == "") { ?>
		<td><div id="elh_socios_cel" class="socios_cel"><div class="ewTableHeaderCaption"><?php echo $socios->cel->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $socios->SortUrl($socios->cel) ?>',1);"><div id="elh_socios_cel" class="socios_cel">
...
<?php if ($socios->cuit_cuil->Visible) { // cuit_cuil ?>
	<?php if ($socios->SortUrl($socios->cuit_cuil) == "") { ?>
		<td><div id="elh_socios_cuit_cuil" class="socios_cuit_cuil"><div class="ewTableHeaderCaption"><?php echo $socios->cuit_cuil->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $socios->SortUrl($socios->cuit_cuil) ?>',1);"><div id="elh_socios_cuit_cuil" class="socios_cuit_cuil">
...
<div id="orig<?php echo $socios_list->RowCnt ?>_socios_id_usuario" class="hide">
<span<?php echo $socios->id_usuario->ViewAttributes() ?>>
<?php echo $socios->id_usuario->ListViewValue() ?></span>
</div>
<div id="swfo_x<?php echo $socios_list->RowCnt ?>_id_usuario"></div><script type="text/javascript">
ewFlashSWFs[ewFlashSWFs.length] = jQuery.extend({"id":"swfo_x<?php echo $socios_list->RowCnt ?>_id_usuario","width":200,"height":200,"version":"9.0.0","bgcolor":"#FFFFFF"}, {
});
</script>
<a id="<?php echo $socios_list->PageObjName . "_row_" . $socios_list->RowCnt ?>"></a></td>
	<?php } ?>

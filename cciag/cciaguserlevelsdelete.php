...
class cuserlevels_delete extends cuserlevels {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("cciaguserlevelslist.php"); // Prevent SQL injection, return to list
...
if ($userlevels_deleteTotalRecs <= 0) { // No record found, exit
	...
	$userlevels_delete->Page_Terminate("cciaguserlevelslist.php"); // Return to list
}
?>

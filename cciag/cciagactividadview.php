...
class cactividad_view extends cactividad {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "cciagactividadlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cciagactividadlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cciagactividadlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_actividad\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_actividad',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.factividadview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Page object
var actividad_view = new ew_Page("actividad_view");
actividad_view.PageID = "view"; // Page ID
var EW_PAGE_ID = actividad_view.PageID; // For backward compatibility

// Form object
var factividadview = new ew_Form("factividadview");
...
factividadview.Lists["x_id_rubro"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_rubro","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if (!$actividad_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="factividadview" id="factividadview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="actividad">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_actividadview" class="table table-bordered table-striped">

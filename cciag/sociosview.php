	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["socio_nro"] <> "") {
				...
				$sReturnUrl = "socioslist.php"; // Return to list
			}
...
fsociosview.Lists["x_id_rubro"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_rubro","x_Descripcion","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fsociosview.Lists["x_id_usuario"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_usuario","x_nombre","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($socios->id_rubro->Visible) { // id_rubro ?>
	<tr id="r_id_rubro">
		<td><span id="elh_socios_id_rubro"><?php echo $socios->id_rubro->FldCaption() ?></span></td>
...
<?php echo $socios->id_rubro->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

...
class cmontos_delete extends cmontos {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("montoslist.php"); // Prevent SQL injection, return to list
...
if ($montos_deleteTotalRecs <= 0) { // No record found, exit
	...
	$montos_delete->Page_Terminate("montoslist.php"); // Return to list
}
?>
...
?>
<form name="fmontosdelete" id="fmontosdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_montosdelete" class="ewTable ewTableSeparate">
<?php echo $montos->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($montos->id->Visible) { // id ?>
		<td><span id="elh_montos_id" class="montos_id"><?php echo $montos->id->FldCaption() ?></span></td>
<?php } ?>
<?php if ($montos->descripcion->Visible) { // descripcion ?>
		<td><span id="elh_montos_descripcion" class="montos_descripcion"><?php echo $montos->descripcion->FldCaption() ?></span></td>
<?php } ?>
<?php if ($montos->importe->Visible) { // importe ?>
		<td><span id="elh_montos_importe" class="montos_importe"><?php echo $montos->importe->FldCaption() ?></span></td>
<?php } ?>
<?php if ($montos->fecha_creacion->Visible) { // fecha_creacion ?>
		<td><span id="elh_montos_fecha_creacion" class="montos_fecha_creacion"><?php echo $montos->fecha_creacion->FldCaption() ?></span></td>
<?php } ?>
<?php if ($montos->activa->Visible) { // activa ?>
		<td><span id="elh_montos_activa" class="montos_activa"><?php echo $montos->activa->FldCaption() ?></span></td>
<?php } ?>
<?php if ($montos->id_usuario->Visible) { // id_usuario ?>
		<td><span id="elh_montos_id_usuario" class="montos_id_usuario"><?php echo $montos->id_usuario->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $montos_delete->RowCnt ?>_montos_id" class="control-group montos_id">
...
<span id="el<?php echo $montos_delete->RowCnt ?>_montos_descripcion" class="control-group montos_descripcion">
...
<span id="el<?php echo $montos_delete->RowCnt ?>_montos_importe" class="control-group montos_importe">
...
<span id="el<?php echo $montos_delete->RowCnt ?>_montos_fecha_creacion" class="control-group montos_fecha_creacion">
...
<span id="el<?php echo $montos_delete->RowCnt ?>_montos_activa" class="control-group montos_activa">
...
<span id="el<?php echo $montos_delete->RowCnt ?>_montos_id_usuario" class="control-group montos_id_usuario">

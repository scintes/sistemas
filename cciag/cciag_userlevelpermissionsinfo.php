...
class cuserlevelpermissions extends cTable {
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cciag_userlevelpermissionslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_userlevelpermissionsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_userlevelpermissionsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "cciag_userlevelpermissionsadd.php?" . $this->UrlParm($parm);
		else
			return "cciag_userlevelpermissionsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cciag_userlevelpermissionsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cciag_userlevelpermissionsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cciag_userlevelpermissionsdelete.php", $this->UrlParm());
	}

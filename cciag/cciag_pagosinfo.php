...
class cpagos extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('pagos', 'pagos', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_deuda
		$this->id_deuda = new cField('pagos', 'pagos', 'x_id_deuda', 'id_deuda', '`id_deuda`', '`id_deuda`', 3, -1, FALSE, '`id_deuda`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_deuda->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_deuda'] = &$this->id_deuda;

		// fecha
		$this->fecha = new cField('pagos', 'pagos', 'x_fecha', 'fecha', '`fecha`', 'DATE_FORMAT(`fecha`, \'%d/%m/%Y\')', 133, 7, FALSE, '`fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fecha->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['fecha'] = &$this->fecha;

		// monto
		$this->monto = new cField('pagos', 'pagos', 'x_monto', 'monto', '`monto`', '`monto`', 131, -1, FALSE, '`monto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->monto->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['monto'] = &$this->monto;

		// id_usuario
		$this->id_usuario = new cField('pagos', 'pagos', 'x_id_usuario', 'id_usuario', '`id_usuario`', '`id_usuario`', 3, -1, FALSE, '`id_usuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`pagos`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_pagosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_pagosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "cciag_pagosadd.php?" . $this->UrlParm($parm);
		else
			return "cciag_pagosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cciag_pagosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cciag_pagosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cciag_pagosdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `pagos`";

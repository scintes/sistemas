...
$cant_socios_actividad = NULL;

//
// Table class for cant_socios_actividad
//
class ccant_socios_actividad extends cTable {
	var $socio_nro;
	var $actividad;
	...
	function __construct() {
		...
		$this->TableVar = 'cant_socios_actividad';
		$this->TableName = 'cant_socios_actividad';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// socio_nro
		$this->socio_nro = new cField('cant_socios_actividad', 'cant_socios_actividad', 'x_socio_nro', 'socio_nro', '`socio_nro`', '`socio_nro`', 20, -1, FALSE, '`socio_nro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->socio_nro->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['socio_nro'] = &$this->socio_nro;

		// actividad
		$this->actividad = new cField('cant_socios_actividad', 'cant_socios_actividad', 'x_actividad', 'actividad', '`actividad`', '`actividad`', 200, -1, FALSE, '`actividad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`cant_socios_actividad`";
	}
	...
	// Update Table
	var $UpdateTable = "`cant_socios_actividad`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cciag_cant_socios_actividadlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_cant_socios_actividadview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_cant_socios_actividadview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "cciag_cant_socios_actividadadd.php?" . $this->UrlParm($parm);
		else
			return "cciag_cant_socios_actividadadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cciag_cant_socios_actividadedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cciag_cant_socios_actividadadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cciag_cant_socios_actividaddelete.php", $this->UrlParm());
	}

	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "cciagusuariolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cciagusuariolist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cciagusuariolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")

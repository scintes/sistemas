...
class crubros_view extends crubros {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "cciagrubroslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cciagrubroslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cciagrubroslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_rubros\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_rubros',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.frubrosview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
<?php if (!$rubros_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="frubrosview" id="frubrosview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="rubros">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_rubrosview" class="table table-bordered table-striped">

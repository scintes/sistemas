...
$seguimiento_tramites_view = NULL; // Initialize page object first

class cseguimiento_tramites_view extends cseguimiento_tramites {
	...
	// Page object name
	var $PageObjName = 'seguimiento_tramites_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["id_tramite"] <> "") {
			$this->RecKey["id_tramite"] = $_GET["id_tramite"];
			$KeyUrl .= "&amp;id_tramite=" . urlencode($this->RecKey["id_tramite"]);
		}
		if (@$_GET["fecha"] <> "") {
		...
		if (@$_GET["hora"] <> "") {
			$this->RecKey["hora"] = $_GET["hora"];
			$KeyUrl .= "&amp;hora=" . urlencode($this->RecKey["hora"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["id_tramite"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["id_tramite"]);
		}
		if (@$_GET["fecha"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
		...
		if (@$_GET["hora"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
			$gsExportFile .= ew_StripSlashes($_GET["hora"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_tramite"] <> "") {
				...
				$this->RecKey["id_tramite"] = $this->id_tramite->QueryStringValue;
			} else {
				$sReturnUrl = "cciag_seguimiento_tramiteslist.php"; // Return to list
			}
			if (@$_GET["fecha"] <> "") {
			...
			if (@$_GET["hora"] <> "") {
				...
				$this->RecKey["hora"] = $this->hora->QueryStringValue;
			} else {
				$sReturnUrl = "cciag_seguimiento_tramiteslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cciag_seguimiento_tramiteslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cciag_seguimiento_tramiteslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($seguimiento_tramites_view)) $seguimiento_tramites_view = new cseguimiento_tramites_view();

// Page init
$seguimiento_tramites_view->Page_Init();

// Page main
$seguimiento_tramites_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$seguimiento_tramites_view->Page_Render();
?>
...
// Page object
var seguimiento_tramites_view = new ew_Page("seguimiento_tramites_view");
seguimiento_tramites_view.PageID = "view"; // Page ID
var EW_PAGE_ID = seguimiento_tramites_view.PageID; // For backward compatibility

// Form object
var fseguimiento_tramitesview = new ew_Form("fseguimiento_tramitesview");

// Form_CustomValidate event
fseguimiento_tramitesview.Form_CustomValidate = 
...
fseguimiento_tramitesview.ValidateRequired = true;
<?php } else { ?>
fseguimiento_tramitesview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fseguimiento_tramitesview.Lists["x_id_tramite"] = {"LinkField":"x_codigo","Ajax":true,"AutoFill":false,"DisplayFields":["x_codigo","x_fecha","x_Titulo",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php } ?>
<?php $seguimiento_tramites_view->ExportOptions->Render("body") ?>
<?php
	foreach ($seguimiento_tramites_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($seguimiento_tramites->Export == "") { ?>
...
<?php } ?>
<?php $seguimiento_tramites_view->ShowPageHeader(); ?>
<?php
$seguimiento_tramites_view->ShowMessage();
?>
<form name="fseguimiento_tramitesview" id="fseguimiento_tramitesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($seguimiento_tramites_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $seguimiento_tramites_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="seguimiento_tramites">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($seguimiento_tramites->id_tramite->Visible) { // id_tramite ?>
	<tr id="r_id_tramite">
		<td><span id="elh_seguimiento_tramites_id_tramite"><?php echo $seguimiento_tramites->id_tramite->FldCaption() ?></span></td>
		<td<?php echo $seguimiento_tramites->id_tramite->CellAttributes() ?>>
<span id="el_seguimiento_tramites_id_tramite" class="form-group">
<span<?php echo $seguimiento_tramites->id_tramite->ViewAttributes() ?>>
<?php echo $seguimiento_tramites->id_tramite->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($seguimiento_tramites->fecha->Visible) { // fecha ?>
	<tr id="r_fecha">
		<td><span id="elh_seguimiento_tramites_fecha"><?php echo $seguimiento_tramites->fecha->FldCaption() ?></span></td>
		<td<?php echo $seguimiento_tramites->fecha->CellAttributes() ?>>
<span id="el_seguimiento_tramites_fecha" class="form-group">
<span<?php echo $seguimiento_tramites->fecha->ViewAttributes() ?>>
<?php echo $seguimiento_tramites->fecha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($seguimiento_tramites->hora->Visible) { // hora ?>
	<tr id="r_hora">
		<td><span id="elh_seguimiento_tramites_hora"><?php echo $seguimiento_tramites->hora->FldCaption() ?></span></td>
		<td<?php echo $seguimiento_tramites->hora->CellAttributes() ?>>
<span id="el_seguimiento_tramites_hora" class="form-group">
<span<?php echo $seguimiento_tramites->hora->ViewAttributes() ?>>
<?php echo $seguimiento_tramites->hora->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($seguimiento_tramites->titulo->Visible) { // titulo ?>
	<tr id="r_titulo">
		<td><span id="elh_seguimiento_tramites_titulo"><?php echo $seguimiento_tramites->titulo->FldCaption() ?></span></td>
		<td<?php echo $seguimiento_tramites->titulo->CellAttributes() ?>>
<span id="el_seguimiento_tramites_titulo" class="form-group">
<span<?php echo $seguimiento_tramites->titulo->ViewAttributes() ?>>
<?php echo $seguimiento_tramites->titulo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($seguimiento_tramites->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td><span id="elh_seguimiento_tramites_descripcion"><?php echo $seguimiento_tramites->descripcion->FldCaption() ?></span></td>
		<td<?php echo $seguimiento_tramites->descripcion->CellAttributes() ?>>
<span id="el_seguimiento_tramites_descripcion" class="form-group">
<span<?php echo $seguimiento_tramites->descripcion->ViewAttributes() ?>>
<?php echo $seguimiento_tramites->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($seguimiento_tramites->archivo->Visible) { // archivo ?>
	<tr id="r_archivo">
		<td><span id="elh_seguimiento_tramites_archivo"><?php echo $seguimiento_tramites->archivo->FldCaption() ?></span></td>
		<td<?php echo $seguimiento_tramites->archivo->CellAttributes() ?>>
<span id="el_seguimiento_tramites_archivo" class="form-group">
...
$Files[$i] = str_replace("%f", ew_HtmlEncode(ew_UploadPathEx(FALSE, $seguimiento_tramites->archivo->UploadPath) . $Files[$i]), $seguimiento_tramites->archivo->ViewValue);
?>
<li>
<?php if ($seguimiento_tramites->archivo->LinkAttributes() <> "") { ?>
<?php if (!empty($seguimiento_tramites->archivo->Upload->DbValue)) { ?>
<?php echo $seguimiento_tramites->archivo->ViewValue ?>
...
<script type="text/javascript">
fseguimiento_tramitesview.Init();
</script>
<?php
$seguimiento_tramites_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($seguimiento_tramites->Export == "") { ?>
...
<?php
$seguimiento_tramites_view->Page_Terminate();
?>

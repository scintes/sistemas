	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "montoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "montoslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "montoslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")

...
class cusuario_edit extends cusuario {
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "")
			$this->Page_Terminate("cciagusuariolist.php"); // Invalid key, return to list
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("cciagusuariolist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
...
<input type="password" data-field="x_contrasenia" name="x_contrasenia" id="x_contrasenia" value="<?php echo $usuario->contrasenia->EditValue ?>" size="50" maxlength="10"<?php echo $usuario->contrasenia->EditAttributes() ?>>
</span>

...
class cuserlevelpermissions_delete extends cuserlevelpermissions {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("cciaguserlevelpermissionslist.php"); // Prevent SQL injection, return to list
...
fuserlevelpermissionsdelete.Lists["x_userlevelid"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($userlevelpermissions_deleteTotalRecs <= 0) { // No record found, exit
	...
	$userlevelpermissions_delete->Page_Terminate("cciaguserlevelpermissionslist.php"); // Return to list
}
?>

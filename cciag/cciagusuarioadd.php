		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "cciagusuarioview.php")
...
<input type="password" data-field="x_contrasenia" name="x_contrasenia" id="x_contrasenia" size="50" maxlength="10"<?php echo $usuario->contrasenia->EditAttributes() ?>>
</span>

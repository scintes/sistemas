...
<?php include_once "cciagsocios_cuotasinfo.php" ?>
...
class csocios_cuotas_list extends csocios_cuotas {
	...
	function __construct() {
		...
		$this->AddUrl = "cciagsocios_cuotasadd.php";
		$this->InlineAddUrl = $this->PageUrl() . "a=add";
		$this->GridAddUrl = $this->PageUrl() . "a=gridadd";
		$this->GridEditUrl = $this->PageUrl() . "a=gridedit";
		$this->MultiDeleteUrl = "cciagsocios_cuotasdelete.php";
		$this->MultiUpdateUrl = "cciagsocios_cuotasupdate.php";

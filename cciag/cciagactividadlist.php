...
class cactividad_list extends cactividad {
	...
	function __construct() {
		...
		$this->AddUrl = "cciagactividadadd.php";
		$this->InlineAddUrl = $this->PageUrl() . "a=add";
		$this->GridAddUrl = $this->PageUrl() . "a=gridadd";
		$this->GridEditUrl = $this->PageUrl() . "a=gridedit";
		$this->MultiDeleteUrl = "cciagactividaddelete.php";
		$this->MultiUpdateUrl = "cciagactividadupdate.php";
	...
	function RenderOtherOptions() {
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->CustomActions as $action => $name) {
				...
				$item->Body = "<a class=\"ewAction ewCustomAction\" href=\"\" onclick=\"ew_SubmitSelected(document.factividadlist, '" . ew_CurrentUrl() . "', null, '" . $action . "');return false;\">" . $name . "</a>";
			}
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_actividad\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_actividad',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.factividadlist,sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
// Page object
var actividad_list = new ew_Page("actividad_list");
actividad_list.PageID = "list"; // Page ID
var EW_PAGE_ID = actividad_list.PageID; // For backward compatibility

// Form object
var factividadlist = new ew_Form("factividadlist");
...
factividadlist.Lists["x_id_rubro"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_rubro","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};

// Form object for search
var factividadlistsrch = new ew_Form("factividadlistsrch");
</script>
<script type="text/javascript">
...
<?php } ?>
<?php if ($actividad_list->ExportOptions->Visible()) { ?>
<div class="ewListExportOptions"><?php $actividad_list->ExportOptions->Render("body") ?></div>
<?php } ?>
<?php
	$bSelectLimit = EW_SELECT_LIMIT;
	if ($bSelectLimit) {
		...
		if ($actividad_list->Recordset = $actividad_list->LoadRecordset())
...
<form name="factividadlistsrch" id="factividadlistsrch" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>">
<table class="ewSearchTable"><tr><td>
<div class="accordion" id="factividadlistsrch_SearchGroup">
	<div class="accordion-group">
		<div class="accordion-heading">
<a class="accordion-toggle" data-toggle="collapse" data-parent="#factividadlistsrch_SearchGroup" href="#factividadlistsrch_SearchBody"><?php echo $Language->Phrase("Search") ?></a>
		</div>
		<div id="factividadlistsrch_SearchBody" class="accordion-body collapse in">
			<div class="accordion-inner">
<div id="factividadlistsrch_SearchPanel">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="input-large" value="<?php echo ew_HtmlEncode($actividad_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo $Language->Phrase("Search") ?>">
	<button class="btn btn-primary ewButton" name="btnsubmit" id="btnsubmit" type="submit"><?php echo $Language->Phrase("QuickSearchBtn") ?></button>
	</div>
	</div>
	<div class="btn-group ewButtonGroup">
	<a class="btn ewShowAll" href="<?php echo $actividad_list->PageUrl() ?>cmd=reset"><?php echo $Language->Phrase("ShowAll") ?></a>
</div>
<div id="xsr_2" class="ewRow">
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="="<?php if ($actividad_list->BasicSearch->getType() == "=") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="AND"<?php if ($actividad_list->BasicSearch->getType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="OR"<?php if ($actividad_list->BasicSearch->getType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?></label>
</div>
</div>
</div>
			</div>
...
<!--first page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $actividad_list->PageUrl() ?>start=<?php echo $actividad_list->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
...
<!--previous page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $actividad_list->PageUrl() ?>start=<?php echo $actividad_list->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" type="button" disabled="disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $actividad_list->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($actividad_list->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" type="button" href="<?php echo $actividad_list->PageUrl() ?>start=<?php echo $actividad_list->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" type="button" disabled="disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($actividad_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" type="button" href="<?php echo $actividad_list->PageUrl() ?>start=<?php echo $actividad_list->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" type="button" disabled="disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $actividad_list->Pager->PageCount ?>
</td>
<td>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $actividad_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $actividad_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $actividad_list->Pager->RecordCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
	<?php if ($actividad_list->SearchWhere == "0=101") { ?>
...
<?php } ?>
<form name="factividadlist" id="factividadlist" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="actividad">
<div id="gmp_actividad" class="ewGridMiddlePanel">
<?php if ($actividad_list->TotalRecs > 0) { ?>
<table id="tbl_actividadlist" class="ewTable ewTableSeparate">
...
<?php if ($actividad->id->Visible) { // id ?>
	<?php if ($actividad->SortUrl($actividad->id) == "") { ?>
		<td><div id="elh_actividad_id" class="actividad_id"><div class="ewTableHeaderCaption"><?php echo $actividad->id->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $actividad->SortUrl($actividad->id) ?>',1);"><div id="elh_actividad_id" class="actividad_id">
...
<?php if ($actividad->id_rubro->Visible) { // id_rubro ?>
	<?php if ($actividad->SortUrl($actividad->id_rubro) == "") { ?>
		<td><div id="elh_actividad_id_rubro" class="actividad_id_rubro"><div class="ewTableHeaderCaption"><?php echo $actividad->id_rubro->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $actividad->SortUrl($actividad->id_rubro) ?>',1);"><div id="elh_actividad_id_rubro" class="actividad_id_rubro">
...
<?php if ($actividad->actividad->Visible) { // actividad ?>
	<?php if ($actividad->SortUrl($actividad->actividad) == "") { ?>
		<td><div id="elh_actividad_actividad" class="actividad_actividad"><div class="ewTableHeaderCaption"><?php echo $actividad->actividad->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $actividad->SortUrl($actividad->actividad) ?>',1);"><div id="elh_actividad_actividad" class="actividad_actividad">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $actividad->actividad->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($actividad->actividad->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($actividad->actividad->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($actividad->descripcion->Visible) { // descripcion ?>
	<?php if ($actividad->SortUrl($actividad->descripcion) == "") { ?>
		<td><div id="elh_actividad_descripcion" class="actividad_descripcion"><div class="ewTableHeaderCaption"><?php echo $actividad->descripcion->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $actividad->SortUrl($actividad->descripcion) ?>',1);"><div id="elh_actividad_descripcion" class="actividad_descripcion">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $actividad->descripcion->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($actividad->descripcion->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($actividad->descripcion->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($actividad->activa->Visible) { // activa ?>
	<?php if ($actividad->SortUrl($actividad->activa) == "") { ?>
		<td><div id="elh_actividad_activa" class="actividad_activa"><div class="ewTableHeaderCaption"><?php echo $actividad->activa->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $actividad->SortUrl($actividad->activa) ?>',1);"><div id="elh_actividad_activa" class="actividad_activa">

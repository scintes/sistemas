...
class cuserlevelpermissions_view extends cuserlevelpermissions {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cciag_userlevelpermissionslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cciag_userlevelpermissionslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")

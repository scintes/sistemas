...
class cdeudas extends cTable {
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "detalle_deudas") {
			$sDetailUrl = $GLOBALS["detalle_deudas"]->GetListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "pagos") {
			$sDetailUrl = $GLOBALS["pagos"]->GetListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "cciag_deudaslist.php";
		}
		return $sDetailUrl;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_deudasview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_deudasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "cciag_deudasadd.php?" . $this->UrlParm($parm);
		else
			return "cciag_deudasadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_deudasedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_deudasedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_deudasadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_deudasadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cciag_deudasdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `deudas`";

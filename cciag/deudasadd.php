		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "deudasview.php")
...
<input type="text" data-field="x_id" name="x_id" id="x_id" size="30" placeholder="<?php echo $deudas->id->PlaceHolder ?>" value="<?php echo $deudas->id->EditValue ?>"<?php echo $deudas->id->EditAttributes() ?>>
</span>

...
//
// Table class for detalles
//
class cdetalles extends cTable {
	var $codigo;
	var $nombre;
	var $descripcion;
	var $activa;
	...
	function __construct() {
		...
		// codigo
		$this->codigo = new cField('detalles', 'detalles', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 3, -1, FALSE, '`codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->codigo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['codigo'] = &$this->codigo;

		// nombre
		$this->nombre = new cField('detalles', 'detalles', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, -1, FALSE, '`nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nombre'] = &$this->nombre;

		// descripcion
		$this->descripcion = new cField('detalles', 'detalles', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 201, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['descripcion'] = &$this->descripcion;

		// activa
		$this->activa = new cField('detalles', 'detalles', 'x_activa', 'activa', '`activa`', '`activa`', 200, -1, FALSE, '`activa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		if ($sDetailUrl == "") {
			$sDetailUrl = "cciag_detalleslist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`detalles`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_detallesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_detallesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "cciag_detallesadd.php?" . $this->UrlParm($parm);
		else
			return "cciag_detallesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_detallesedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_detallesedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_detallesadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_detallesadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cciag_detallesdelete.php", $this->UrlParm());
	}

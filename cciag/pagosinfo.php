...
class cpagos extends cTable {
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("pagosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("pagosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("pagosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("pagosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("pagosdelete.php", $this->UrlParm());
	}

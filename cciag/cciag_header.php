...
if (!isset($Language)) {
	include_once "cciag_ewcfg11.php";
...
<script type="text/javascript" src="<?php echo $EW_RELATIVE_PATH ?>phpjs/cciag_eweditor.js"></script>
...
// Ajax settings
var EW_LOOKUP_FILE_NAME = "cciag_ewlookup11.php"; // Lookup file name

...
class cactividad extends cTable {
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("actividadview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("actividadview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "actividadadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("actividadedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("actividadadd.php", $this->UrlParm($parm));
	}

...
fsocioslist.Lists["x_id_rubro"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_rubro","x_Descripcion","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fsocioslist.Lists["x_id_usuario"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_usuario","x_nombre","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($socios->id_rubro->Visible) { // id_rubro ?>
	<?php if ($socios->SortUrl($socios->id_rubro) == "") { ?>
		<td><div id="elh_socios_id_rubro" class="socios_id_rubro"><div class="ewTableHeaderCaption"><?php echo $socios->id_rubro->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $socios->SortUrl($socios->id_rubro) ?>',1);"><div id="elh_socios_id_rubro" class="socios_id_rubro">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $socios->id_rubro->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($socios->id_rubro->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($socios->id_rubro->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		

...
class cdeudas_list extends cdeudas {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_deudas\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_deudas',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fdeudaslist,sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
fdeudaslist.Lists["x_id_usuario"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_usuario","x_nombre","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<form name="fdeudaslistsrch" id="fdeudaslistsrch" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>">
<table class="ewSearchTable"><tr><td>
<div class="accordion" id="fdeudaslistsrch_SearchGroup">
	<div class="accordion-group">
		<div class="accordion-heading">
<a class="accordion-toggle" data-toggle="collapse" data-parent="#fdeudaslistsrch_SearchGroup" href="#fdeudaslistsrch_SearchBody"><?php echo $Language->Phrase("Search") ?></a>
		</div>
		<div id="fdeudaslistsrch_SearchBody" class="accordion-body collapse in">
			<div class="accordion-inner">
<div id="fdeudaslistsrch_SearchPanel">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="input-large" value="<?php echo ew_HtmlEncode($deudas_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo $Language->Phrase("Search") ?>">
	<button class="btn btn-primary ewButton" name="btnsubmit" id="btnsubmit" type="submit"><?php echo $Language->Phrase("QuickSearchBtn") ?></button>
	</div>
	</div>
	<div class="btn-group ewButtonGroup">
	<a class="btn ewShowAll" href="<?php echo $deudas_list->PageUrl() ?>cmd=reset"><?php echo $Language->Phrase("ShowAll") ?></a>
</div>
<div id="xsr_2" class="ewRow">
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="="<?php if ($deudas_list->BasicSearch->getType() == "=") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="AND"<?php if ($deudas_list->BasicSearch->getType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="OR"<?php if ($deudas_list->BasicSearch->getType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?></label>
</div>
</div>
</div>
			</div>
...
<form name="fdeudaslist" id="fdeudaslist" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="deudas">
<div id="gmp_deudas" class="ewGridMiddlePanel">
<?php if ($deudas_list->TotalRecs > 0) { ?>
<table id="tbl_deudaslist" class="ewTable ewTableSeparate">
...
<?php if ($deudas->id->Visible) { // id ?>
	<?php if ($deudas->SortUrl($deudas->id) == "") { ?>
		<td><div id="elh_deudas_id" class="deudas_id"><div class="ewTableHeaderCaption"><?php echo $deudas->id->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $deudas->SortUrl($deudas->id) ?>',1);"><div id="elh_deudas_id" class="deudas_id">
...
<?php if ($deudas->mes->Visible) { // mes ?>
	<?php if ($deudas->SortUrl($deudas->mes) == "") { ?>
		<td><div id="elh_deudas_mes" class="deudas_mes"><div class="ewTableHeaderCaption"><?php echo $deudas->mes->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $deudas->SortUrl($deudas->mes) ?>',1);"><div id="elh_deudas_mes" class="deudas_mes">
...
<?php if ($deudas->anio->Visible) { // anio ?>
	<?php if ($deudas->SortUrl($deudas->anio) == "") { ?>
		<td><div id="elh_deudas_anio" class="deudas_anio"><div class="ewTableHeaderCaption"><?php echo $deudas->anio->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $deudas->SortUrl($deudas->anio) ?>',1);"><div id="elh_deudas_anio" class="deudas_anio">
...
<?php if ($deudas->fecha->Visible) { // fecha ?>
	<?php if ($deudas->SortUrl($deudas->fecha) == "") { ?>
		<td><div id="elh_deudas_fecha" class="deudas_fecha"><div class="ewTableHeaderCaption"><?php echo $deudas->fecha->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $deudas->SortUrl($deudas->fecha) ?>',1);"><div id="elh_deudas_fecha" class="deudas_fecha">
...
<?php if ($deudas->monto->Visible) { // monto ?>
	<?php if ($deudas->SortUrl($deudas->monto) == "") { ?>
		<td><div id="elh_deudas_monto" class="deudas_monto"><div class="ewTableHeaderCaption"><?php echo $deudas->monto->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $deudas->SortUrl($deudas->monto) ?>',1);"><div id="elh_deudas_monto" class="deudas_monto">
...
<?php if ($deudas->id_usuario->Visible) { // id_usuario ?>
	<?php if ($deudas->SortUrl($deudas->id_usuario) == "") { ?>
		<td><div id="elh_deudas_id_usuario" class="deudas_id_usuario"><div class="ewTableHeaderCaption"><?php echo $deudas->id_usuario->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $deudas->SortUrl($deudas->id_usuario) ?>',1);"><div id="elh_deudas_id_usuario" class="deudas_id_usuario">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $deudas->id_usuario->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($deudas->id_usuario->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($deudas->id_usuario->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
<!--first page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $deudas_list->PageUrl() ?>start=<?php echo $deudas_list->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
...
<!--previous page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $deudas_list->PageUrl() ?>start=<?php echo $deudas_list->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" type="button" disabled="disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $deudas_list->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($deudas_list->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" type="button" href="<?php echo $deudas_list->PageUrl() ?>start=<?php echo $deudas_list->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" type="button" disabled="disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($deudas_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" type="button" href="<?php echo $deudas_list->PageUrl() ?>start=<?php echo $deudas_list->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" type="button" disabled="disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $deudas_list->Pager->PageCount ?>
</td>
<td>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $deudas_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $deudas_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $deudas_list->Pager->RecordCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
	<?php if ($deudas_list->SearchWhere == "0=101") { ?>

...
$pagos_grid = NULL; // Initialize page object first

class cpagos_grid extends cpagos {
	...
	// Page object name
	var $PageObjName = 'pagos_grid';

	// Grid form hidden field names
	var $FormName = 'fpagosgrid';
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			if (!$GLOBALS["pagos"]->UserIDAllow("gridcls")) $sWhereWrk = $GLOBALS["deudas"]->AddUserIDFilter($sWhereWrk);

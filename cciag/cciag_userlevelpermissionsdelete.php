...
class cuserlevelpermissions_delete extends cuserlevelpermissions {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("cciag_userlevelpermissionslist.php"); // Prevent SQL injection, return to list
...
if ($userlevelpermissions_deleteTotalRecs <= 0) { // No record found, exit
	...
	$userlevelpermissions_delete->Page_Terminate("cciag_userlevelpermissionslist.php"); // Return to list
}
?>
<div class="ewToolbar">

...
$tramites_archivo_blobview = NULL; // Initialize page object first

class ctramites_archivo_blobview extends ctramites {
	...
	// Page object name
	var $PageObjName = 'tramites_archivo_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('tramites', 'x_archivo');
...
// Create page object
if (!isset($tramites_archivo_blobview)) $tramites_archivo_blobview = new ctramites_archivo_blobview();

// Page init
$tramites_archivo_blobview->Page_Init();

// Page main
$tramites_archivo_blobview->Page_Main();
?>
<?php
$tramites_archivo_blobview->Page_Terminate();
?>

...
<br>
<a class="ewLink ewLinkSeparator" href="cciag_forgotpwd.php"><?php echo $Language->Phrase("ForgotPwd") ?></a>
<a class="ewLink ewLinkSeparator" href="cciag_register.php"><?php echo $Language->Phrase("Register") ?></a>
<script type="text/javascript">
flogin.Init();
</script>
<?php

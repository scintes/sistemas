...
class cuserpriv extends cuserlevels {
	...
	function Page_Init() {
		...
		if ($Security->IsLoggedIn() && strval($Security->CurrentUserID()) == "") {
			...
			$this->Page_Terminate("cciaguserlevelslist.php");
		}
	...
	function Page_Main() {
		...
		$Breadcrumb->Add("list", "<span>" . $Language->TablePhrase("userlevels", "TblCaption") . "</span>", "cciaguserlevelslist.php", "userlevels");
		...
		if (@$_POST["a_edit"] == "") {
			...
			if (@$_GET["userlevelid"] <> "") {
				...
				$this->Page_Terminate("cciaguserlevelslist.php"); // Return to list
			}

...
<br>
<a class="ewLink ewLinkSeparator" href="cciagforgotpwd.php"><?php echo $Language->Phrase("ForgotPwd") ?></a>
<a class="ewLink ewLinkSeparator" href="cciagregister.php"><?php echo $Language->Phrase("Register") ?></a>
<script type="text/javascript">
flogin.Init();

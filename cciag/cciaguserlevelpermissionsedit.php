...
class cuserlevelpermissions_edit extends cuserlevelpermissions {
	...
	function Page_Main() {
		...
		if ($this->userlevelid->CurrentValue == "")
			$this->Page_Terminate("cciaguserlevelpermissionslist.php"); // Invalid key, return to list
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("cciaguserlevelpermissionslist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
...
fuserlevelpermissionsedit.Lists["x_userlevelid"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};

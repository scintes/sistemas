...
define("EW_RANDOM_KEY", 'bCm1KmW7wL3mEYaE', TRUE); // Random key for encryption
...
define("EW_USER_ACTIVATE_FILTER", "(`activo` = 'Y')",  TRUE);
...
define("EW_UPLOAD_URL", "cciagewupload10.php", TRUE); // Upload URL
...
?>
<?php
define("EW_PDF_STYLESHEET_FILENAME", "phpcss/cciagewpdf.css", TRUE); // export PDF CSS styles

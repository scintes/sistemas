...
$RootMenu->AddMenuItem(51, "mci_Usuarios", $Language->MenuPhrase("51", "MenuText"), "", 50, "", IsLoggedIn(), FALSE, TRUE);
...
$RootMenu->AddMenuItem(28, "mi_acerca_de_php", $Language->MenuPhrase("28", "MenuText"), "inicio/acerca_de.php", -1, "", TRUE, FALSE);

...
class cactividad extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('actividad', 'actividad', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_rubro
		$this->id_rubro = new cField('actividad', 'actividad', 'x_id_rubro', 'id_rubro', '`id_rubro`', '`id_rubro`', 3, -1, FALSE, '`id_rubro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_rubro->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_rubro'] = &$this->id_rubro;

		// actividad
		$this->actividad = new cField('actividad', 'actividad', 'x_actividad', 'actividad', '`actividad`', '`actividad`', 200, -1, FALSE, '`actividad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['actividad'] = &$this->actividad;

		// descripcion
		$this->descripcion = new cField('actividad', 'actividad', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 200, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['descripcion'] = &$this->descripcion;

		// activa
		$this->activa = new cField('actividad', 'actividad', 'x_activa', 'activa', '`activa`', '`activa`', 200, -1, FALSE, '`activa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "rubros") {
			if ($this->id_rubro->getSessionValue() <> "")
				$sMasterFilter .= "`id`=" . ew_QuotedValue($this->id_rubro->getSessionValue(), EW_DATATYPE_NUMBER);
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "rubros") {
			if ($this->id_rubro->getSessionValue() <> "")
				$sDetailFilter .= "`id_rubro`=" . ew_QuotedValue($this->id_rubro->getSessionValue(), EW_DATATYPE_NUMBER);
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_rubros() {
		return "`id`=@id@";
	}

	// Detail filter
	function SqlDetailFilter_rubros() {
		return "`id_rubro`=@id_rubro@";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cciag_actividadlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_actividadview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_actividadview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "cciag_actividadadd.php?" . $this->UrlParm($parm);
		else
			return "cciag_actividadadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cciag_actividadedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cciag_actividadadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cciag_actividaddelete.php", $this->UrlParm());
	}

...
class cusuario_delete extends cusuario {
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("cciag_usuariolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->Recordset = ew_LoadRecordset($sql)) {
			...
			if (!$res) $this->Page_Terminate("cciag_usuariolist.php"); // Return to list
		}
...
if ($usuario_deleteTotalRecs <= 0) { // No record found, exit
	...
	$usuario_delete->Page_Terminate("cciag_usuariolist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
<?php if ($usuario->contrasenia->Visible) { // contrasenia ?>
		<th><span id="elh_usuario_contrasenia" class="usuario_contrasenia"><?php echo $usuario->contrasenia->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($usuario->cel->Visible) { // cel ?>
		<th><span id="elh_usuario_cel" class="usuario_cel"><?php echo $usuario->cel->FldCaption() ?></span></th>
<?php } ?>

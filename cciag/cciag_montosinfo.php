...
//
// Table class for montos
//
class cmontos extends cTable {
	var $id;
	var $descripcion;
	var $importe;
	var $fecha_creacion;
	...
	function GetDetailUrl() {
		...
		if ($sDetailUrl == "") {
			$sDetailUrl = "cciag_montoslist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`montos`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_montosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_montosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "cciag_montosadd.php?" . $this->UrlParm($parm);
		else
			return "cciag_montosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_montosedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_montosedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_montosadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_montosadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cciag_montosdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `montos`";

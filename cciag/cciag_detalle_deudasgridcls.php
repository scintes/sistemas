...
$detalle_deudas_grid = NULL; // Initialize page object first

class cdetalle_deudas_grid extends cdetalle_deudas {
	...
	// Page object name
	var $PageObjName = 'detalle_deudas_grid';

	// Grid form hidden field names
	var $FormName = 'fdetalle_deudasgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["detalle_deudas"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			if (!$GLOBALS["detalle_deudas"]->UserIDAllow("gridcls")) $sWhereWrk = $GLOBALS["deudas"]->AddUserIDFilter($sWhereWrk);

...
define("EW_PROJECT_NAME", "cciag", TRUE); // Project name
...
define("EW_RANDOM_KEY", '3pSFPzqISPzT9T4l', TRUE); // Random key for encryption
...
$EW_LANGUAGE_FILE[] = array("sp", "", "spanish.xml");
define("EW_LANGUAGE_DEFAULT_ID", "sp", TRUE);
...
define("EW_USER_PROFILE_PASSWORD_EXPIRE", 86, TRUE);

// Email
define("EW_SMTP_SERVER", "www.cciag-sauceviejo.com.ar", TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", 25, TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", "ssl", TRUE);
define("EW_SMTP_SERVER_USERNAME", "scintes", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "gvk35on", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "smtp.cciag-sauceviejo.com.ar", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "pop.cciag-sauceviejo.com.ar", TRUE); // Recipient email address
...
define("EW_UPLOAD_URL", "cciag_ewupload11.php", TRUE); // Upload URL
...
define("EW_DEFAULT_LOCALE", '{"decimal_point":".","thousands_sep":",","int_curr_symbol":"$","currency_symbol":"$","mon_decimal_point":".","mon_thousands_sep":",","positive_sign":null,"negative_sign":"-","int_frac_digits":2,"frac_digits":2,"p_cs_precedes":true,"p_sep_by_space":false,"n_cs_precedes":true,"n_sep_by_space":false,"p_sign_posn":3,"n_sign_posn":3}', TRUE);
...
?>
<?php
define("EW_PDF_STYLESHEET_FILENAME", "phpcss/cciag_ewpdf.css", TRUE); // export PDF CSS styles

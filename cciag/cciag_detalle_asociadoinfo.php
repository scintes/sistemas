...
$detalle_asociado = NULL;

//
// Table class for detalle_asociado
//
class cdetalle_asociado extends cTable {
	var $socio_nro;
	var $comercio;
	var $total;
	...
	function __construct() {
		...
		$this->TableVar = 'detalle_asociado';
		$this->TableName = 'detalle_asociado';
		$this->TableType = 'VIEW';
		$this->ExportAll = TRUE;
		...
		// socio_nro
		$this->socio_nro = new cField('detalle_asociado', 'detalle_asociado', 'x_socio_nro', 'socio_nro', '`socio_nro`', '`socio_nro`', 3, -1, FALSE, '`socio_nro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->socio_nro->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['socio_nro'] = &$this->socio_nro;

		// comercio
		$this->comercio = new cField('detalle_asociado', 'detalle_asociado', 'x_comercio', 'comercio', '`comercio`', '`comercio`', 200, -1, FALSE, '`comercio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['comercio'] = &$this->comercio;

		// total
		$this->total = new cField('detalle_asociado', 'detalle_asociado', 'x_total', 'total', '`total`', '`total`', 131, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`detalle_asociado`";
	}
	...
	// Update Table
	var $UpdateTable = "`detalle_asociado`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cciag_detalle_asociadolist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_detalle_asociadoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_detalle_asociadoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "cciag_detalle_asociadoadd.php?" . $this->UrlParm($parm);
		else
			return "cciag_detalle_asociadoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cciag_detalle_asociadoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cciag_detalle_asociadoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cciag_detalle_asociadodelete.php", $this->UrlParm());
	}

...
// No functions
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", "<span id=\"ewPageCaption\">" . $PageCaption . "</span>", "actividadlist.php", $this->TableVar);
...
// Page object
var actividad_delete = new ew_Page("actividad_delete");
actividad_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = actividad_delete.PageID; // For backward compatibility

// Form object
var factividaddelete = new ew_Form("factividaddelete");
...
factividaddelete.ValidateRequired = true;
<?php } else { ?>
factividaddelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
factividaddelete.Lists["x_id_rubro"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_rubro","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($actividad_delete->Recordset = $actividad_delete->LoadRecordset())
	$actividad_deleteTotalRecs = $actividad_delete->Recordset->RecordCount(); // Get record count
if ($actividad_deleteTotalRecs <= 0) { // No record found, exit
	if ($actividad_delete->Recordset)
		$actividad_delete->Recordset->Close();
	$actividad_delete->Page_Terminate("actividadlist.php"); // Return to list
}
?>
...
?>
<form name="factividaddelete" id="factividaddelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_actividaddelete" class="ewTable ewTableSeparate">
<?php echo $actividad->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($actividad->id->Visible) { // id ?>
		<td><span id="elh_actividad_id" class="actividad_id"><?php echo $actividad->id->FldCaption() ?></span></td>
<?php } ?>
<?php if ($actividad->id_rubro->Visible) { // id_rubro ?>
		<td><span id="elh_actividad_id_rubro" class="actividad_id_rubro"><?php echo $actividad->id_rubro->FldCaption() ?></span></td>
<?php } ?>
<?php if ($actividad->actividad->Visible) { // actividad ?>
		<td><span id="elh_actividad_actividad" class="actividad_actividad"><?php echo $actividad->actividad->FldCaption() ?></span></td>
<?php } ?>
<?php if ($actividad->descripcion->Visible) { // descripcion ?>
		<td><span id="elh_actividad_descripcion" class="actividad_descripcion"><?php echo $actividad->descripcion->FldCaption() ?></span></td>
<?php } ?>
<?php if ($actividad->activa->Visible) { // activa ?>
		<td><span id="elh_actividad_activa" class="actividad_activa"><?php echo $actividad->activa->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $actividad_delete->RowCnt ?>_actividad_id" class="control-group actividad_id">
...
<span id="el<?php echo $actividad_delete->RowCnt ?>_actividad_id_rubro" class="control-group actividad_id_rubro">
...
<span id="el<?php echo $actividad_delete->RowCnt ?>_actividad_actividad" class="control-group actividad_actividad">
...
<span id="el<?php echo $actividad_delete->RowCnt ?>_actividad_descripcion" class="control-group actividad_descripcion">
...
<span id="el<?php echo $actividad_delete->RowCnt ?>_actividad_activa" class="control-group actividad_activa">

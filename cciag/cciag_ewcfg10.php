...
define("EW_RANDOM_KEY", '4o4RepmCogv7EdL2', TRUE); // Random key for encryption
...
define("EW_ADMIN_PASSWORD", "gvk35on", TRUE); // Administrator password
...
define("EW_UPLOAD_URL", "cciag_ewupload10.php", TRUE); // Upload URL

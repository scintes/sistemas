...
class crubros extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('rubros', 'rubros', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// rubro
		$this->rubro = new cField('rubros', 'rubros', 'x_rubro', 'rubro', '`rubro`', '`rubro`', 200, -1, FALSE, '`rubro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['rubro'] = &$this->rubro;

		// Descripcion
		$this->Descripcion = new cField('rubros', 'rubros', 'x_Descripcion', 'Descripcion', '`Descripcion`', '`Descripcion`', 201, -1, FALSE, '`Descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Descripcion'] = &$this->Descripcion;

		// activa
		$this->activa = new cField('rubros', 'rubros', 'x_activa', 'activa', '`activa`', '`activa`', 200, -1, FALSE, '`activa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		if ($this->getCurrentDetailTable() == "actividad") {
			$sDetailUrl = $GLOBALS["actividad"]->GetListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "cciag_rubroslist.php";
		}
		return $sDetailUrl;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_rubrosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_rubrosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "cciag_rubrosadd.php?" . $this->UrlParm($parm);
		else
			return "cciag_rubrosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_rubrosedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_rubrosedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cciag_rubrosadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cciag_rubrosadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cciag_rubrosdelete.php", $this->UrlParm());
	}

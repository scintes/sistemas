...
$RootMenu->AddMenuItem(27, "mmi_inicio_php", $Language->MenuPhrase("27", "MenuText"), "inicio/inicio.php", -1, "", IsLoggedIn(), FALSE);
$RootMenu->AddMenuItem(13, "mmci_Socios", $Language->MenuPhrase("13", "MenuText"), "", -1, "", IsLoggedIn(), FALSE, TRUE);
$RootMenu->AddMenuItem(6, "mmi_socios", $Language->MenuPhrase("6", "MenuText"), "cciag_socioslist.php", 13, "", IsLoggedIn(), FALSE);
...
$RootMenu->AddMenuItem(16, "mmi_cantidad_socios_por_actividad", $Language->MenuPhrase("16", "MenuText"), "cciag_cantidad_socios_por_actividadreport.php", 13, "", IsLoggedIn(), FALSE);
...
$RootMenu->AddMenuItem(12, "mmci_Contables", $Language->MenuPhrase("12", "MenuText"), "", -1, "", IsLoggedIn(), FALSE, TRUE);
...
$RootMenu->AddMenuItem(51, "mmci_Usuarios", $Language->MenuPhrase("51", "MenuText"), "", 50, "", TRUE, FALSE, TRUE);
...
$RootMenu->AddMenuItem(28, "mmi_acerca_de_php", $Language->MenuPhrase("28", "MenuText"), "inicio/acerca_de.php", -1, "", IsLoggedIn(), FALSE);

...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_id_rubro") && $objForm->HasValue("o_id_rubro") && $this->id_rubro->CurrentValue <> $this->id_rubro->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_actividad") && $objForm->HasValue("o_actividad") && $this->actividad->CurrentValue <> $this->actividad->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->id_rubro->setOldValue($objForm->GetValue("o_id_rubro"));
		if (!$this->actividad->FldIsDetailKey) {
			$this->actividad->setFormValue($objForm->GetValue("x_actividad"));
		}
		$this->actividad->setOldValue($objForm->GetValue("o_actividad"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "rubros") {
			...
			if ($GLOBALS["rubros"]->EventCancelled) $this->EventCancelled = TRUE;
		}

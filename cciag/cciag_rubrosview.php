...
$rubros_view = NULL; // Initialize page object first

class crubros_view extends crubros {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cciag_rubroslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cciag_rubroslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		if ($GLOBALS["actividad_grid"] && $GLOBALS["actividad_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'actividad')) {
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_rubros\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_rubros',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.frubrosview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($rubros_view)) $rubros_view = new crubros_view();

// Page init
$rubros_view->Page_Init();

// Page main
$rubros_view->Page_Main();
...
// Page object
var rubros_view = new ew_Page("rubros_view");
rubros_view.PageID = "view"; // Page ID
var EW_PAGE_ID = rubros_view.PageID; // For backward compatibility

// Form object
var frubrosview = new ew_Form("frubrosview");

// Form_CustomValidate event
frubrosview.Form_CustomValidate = 
...
frubrosview.ValidateRequired = true;
<?php } else { ?>
frubrosview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $rubros_view->ExportOptions->Render("body") ?>
<?php
	foreach ($rubros_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($rubros->Export == "") { ?>
...
<?php } ?>
<?php $rubros_view->ShowPageHeader(); ?>
<?php
$rubros_view->ShowMessage();
?>
<form name="frubrosview" id="frubrosview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rubros_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rubros_view->Token ?>">
<?php } ?>
...
<?php
	if (in_array("actividad", explode(",", $rubros->getCurrentDetailTable())) && $actividad->DetailView) {
?>

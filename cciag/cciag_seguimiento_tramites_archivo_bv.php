...
$seguimiento_tramites_archivo_blobview = NULL; // Initialize page object first

class cseguimiento_tramites_archivo_blobview extends cseguimiento_tramites {
	...
	// Page object name
	var $PageObjName = 'seguimiento_tramites_archivo_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'seguimiento_tramites');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('seguimiento_tramites', 'x_archivo');
		...
		// SQL constructor in seguimiento_tramites class, seguimiento_tramitesinfo.php
...
// Create page object
if (!isset($seguimiento_tramites_archivo_blobview)) $seguimiento_tramites_archivo_blobview = new cseguimiento_tramites_archivo_blobview();

// Page init
$seguimiento_tramites_archivo_blobview->Page_Init();

// Page main
$seguimiento_tramites_archivo_blobview->Page_Main();
?>
<?php
$seguimiento_tramites_archivo_blobview->Page_Terminate();
?>

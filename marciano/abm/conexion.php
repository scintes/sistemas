...
//------------------------------------------------------------------------------
define('SIS_VERSION','0.2 alfa');
define('FECHA_MODI_SISTEMA','23/10/2014');
//------------------------------------------------------------------------------
...
define('IMAGEN_FONDO',''); //imagenes/fondo.jpg');
...
define("USUARIO_PARA_CREAR_AUTOMAT_SALIDAS", 1) ; 
...
define('FORMATO_HORA','hh:mm');       // formato a utilizar en las hora con el sistema
define('FORMATO_FECHA','dd/mm/YYYY'); // Formato a utilizar en las fechas por el sistema

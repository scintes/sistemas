/** TRADUCIDO A ESPAÑOL y ARREGALAS VARIAS COSAS.
 * datepicker.js - MooTools Datepicker class
 * @version 1.17
 * 
 * by MonkeyPhysics.com
 * Update por Cintes Sergio
 * 
...
var DatePicker = new Class({
	...
	options: { 
		...
		yearPicker: true,
		yearsPerPage: 20,
		format: 'd F, Y', //el formato en que se muestra. (no influye en el valor que se envia en el formulario)
		allowEmpty: true,
		inputOutputFormat: 'Y-m-d', //el formato que viene y va desde el formulario
	...
	renderTime: function() {
		...
		if (this.options.timePickerOnly) {
			this.picker.getElement('.titleText').set('text', 'Seleccione la Hora');
		} else {
		...
		new Element('input', { type: 'submit', value: 'Aceptar', 'class': 'ok' })
			.addEvents({
				click: function(e) {
					e.stop();

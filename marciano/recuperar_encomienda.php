...
echo " <div align='center'>
                <table border='0'>
                    <tr>
                        <td>";
                            if (!recuperar_registro('encomiendas', 'nro_guia='.$nro_guia, $tipo,'ELIMINADO')){
                                echo "El registro no pudo recuperarse con exito...<br><br>";
                            }else{
                                echo "El registro fue recuperado con exito<br><br>";
                            };"
